...
struct batch_commands
{
	...
	string set_job_variables, check_status_command, run_command;
	...
	batch_commands(): scheduler_run_job(""), array_dependency_option(""), job_dependency_option(""),
			...
			sheduler_hosts_option(""), sheduler_hosts_separation(','), set_job_variables(""),
			check_status_command(""), run_command(""), batch_temp_directory(""),
	...
	batch_commands(string str_scheduler_run_job, string str_array_dependency_option, string str_job_dependency_option,
			...
			string str_sheduler_hosts_option, char c_sheduler_hosts_separation,	string str_set_job_variables,
			string str_check_status_command, string str_run_command, string str_batch_temp_directory,
			string str_batch_task_id, string str_job_begin):
				...
				sheduler_hosts_option(str_sheduler_hosts_option), sheduler_hosts_separation(c_sheduler_hosts_separation),
				set_job_variables(str_set_job_variables), check_status_command(str_check_status_command),
				run_command(str_run_command), batch_temp_directory(str_batch_temp_directory),
