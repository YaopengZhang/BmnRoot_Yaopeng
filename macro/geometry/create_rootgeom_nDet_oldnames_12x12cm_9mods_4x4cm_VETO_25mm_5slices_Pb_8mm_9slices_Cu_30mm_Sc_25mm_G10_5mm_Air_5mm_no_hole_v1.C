...
// Define ZDC Geometry
  TString zdc_common_name = "NDET_common";
  TGeoVolume *NDET_common = new TGeoVolumeAssembly(zdc_common_name);
  NDET_common->SetMedium(pMedAir);
  //NDET_common->SetMedium(pMedVacuum);
  
  TString zdc_name = "ndet01";
  ...
  TString zdcModule_name_NICA = "ndet01m_NICA";
...
//TString slot_Fe_name = "Fe_slot";
 TString Pb_name_NICA_5mm = "ndet01a_NICA_5mm";
 TString Pb_name_NICA_10mm = "ndet01a_NICA_10mm";
 //TString Pb_name_NICA_20mm = "ndet01a_NICA_20mm";
 TString Air_name_NICA = "ndet01air_NICA";
 TString G10_name_NICA = "ndet01g10_NICA";
 //TString slot_Pb_name = "Pb_slot";
 TString SensitiveVolume_name_NICA = "ndet01s_NICA";
 TString SensitiveVolume_name_VETO = "ndet01s_VETO";
...
*/ 
 ...
 TGeoShape *PbS_NICA_5mm = new TGeoBBox(Pb_name_NICA_5mm, Zdc_Pb_X_size_5mm, Zdc_Pb_Y_size_5mm, Zdc_Pb_Z_size_5mm);
 TGeoVolume *PbV_NICA_5mm = new TGeoVolume(Pb_name_NICA_5mm, PbS_NICA_5mm);
...
TGeoShape *PbS_NICA_10mm = new TGeoBBox(Pb_name_NICA_10mm, Zdc_Pb_X_size_10mm, Zdc_Pb_Y_size_10mm, Zdc_Pb_Z_size_10mm);
 TGeoVolume *PbV_NICA_10mm = new TGeoVolume(Pb_name_NICA_10mm, PbS_NICA_10mm);
 ...
 */
 ...
 TGeoShape *zdcSensitiveVolumeS_VETO = new TGeoBBox(SensitiveVolume_name_VETO, Zdc_Veto_X_size, Zdc_Veto_Y_size, Zdc_Veto_Z_size);
 TGeoVolume *zdcSensitiveVolumeV_VETO = new TGeoVolume(SensitiveVolume_name_VETO, zdcSensitiveVolumeS_VETO);
 ...
 TGeoShape *AirS_NICA = new TGeoBBox(Air_name_NICA, Zdc_Air_X_size, Zdc_Air_Y_size, Zdc_Air_Z_size);
 TGeoVolume *AirV_NICA = new TGeoVolume(Air_name_NICA, AirS_NICA);
 ...
 TGeoShape *G10S_NICA = new TGeoBBox(G10_name_NICA, Zdc_G10_X_size, Zdc_G10_Y_size, Zdc_G10_Z_size);
 TGeoVolume *G10V_NICA = new TGeoVolume(G10_name_NICA, G10S_NICA);
