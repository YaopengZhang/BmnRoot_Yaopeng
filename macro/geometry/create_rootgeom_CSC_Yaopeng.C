...
const Double_t XStationPositions[NStations] = {
    ArmLength_left*sin(ArmAngle_left/180.*TMath::Pi()) + XMagnetPosition /* +98.9 cm */, //station 0 (left arm)
    ArmLength_right*sin(ArmAngle_right/180.*TMath::Pi()) + XMagnetPosition /* -91.66 cm */  //station 1 (right arm)
};
const Double_t YStationPositions[NStations] = {
    +0.0 + YMagnetPosition /* +3.7785 cm */, //station 0 (left arm)
    +0.0 + YMagnetPosition /* +3.7785 cm */ //station 1 (right arm)
};
const Double_t ZStationPositions[NStations] = {
    ArmLength_left*cos(ArmAngle_left/180.*TMath::Pi()) + ZMagnetPosition /* -415.837 cm */, //station 0 (left arm)
    ArmLength_right*cos(ArmAngle_right/180.*TMath::Pi()) + ZMagnetPosition /* -415.837 cm */  //station 1 (right arm)
};
//------------------------------------------------------------------------------
...
const Double_t YModuleShifts[NStations][NMaxModules] = {
    // {37.1875 - 0.127, -17.1875 - 0.127}, //station 0
    // {37.1875 - 0.056, -17.1875 - 0.056}, //station 1
    {27.1875 - 0.127, -27.1875 - 0.127}, //station 0    align_left_csc_y0 = -0.127
    {27.1875 - 0.056, -27.1875 - 0.056}, //station 1    align_right_csc_y0 = -0.056
};
const Double_t ZModuleShifts[NStations][NMaxModules] = {
    {1.25, 1.25}, //station 0   /*distance from the side to the sensor*/
    {1.25, 1.25}, //station 1   /*distance from the side to the sensor*/
};
...
void create_rootgeom_CSC_Yaopeng() {
    ...
    const TString geoDetectorVersion = "Yaopeng";
    ...
    if(1) {
        ...
        TGeoCombiTrans *module0_transform = new TGeoCombiTrans();
            ...
            module0_transform->RotateX(0.0913); //deg
            module0_transform->RotateY(-0.24); //deg
            module0_transform->RotateY(ArmAngle_left); //deg
        ...
        TGeoCombiTrans *module1_transform = new TGeoCombiTrans();
            ...
            module1_transform->RotateX(0.0913); //deg
            module1_transform->RotateY(-0.24); //deg
            module1_transform->RotateY(ArmAngle_left); //deg
        ...
        TGeoCombiTrans *frame0_transform = new TGeoCombiTrans();
            ...
            frame0_transform->RotateX(0.0913); //deg
            frame0_transform->RotateY(-0.24); //deg
            frame0_transform->RotateY(ArmAngle_left); //deg
        ...
        TGeoCombiTrans *frame1_transform = new TGeoCombiTrans();
            ...
            frame1_transform->RotateX(0.0913); //deg
            frame1_transform->RotateY(-0.24); //deg
            frame1_transform->RotateY(ArmAngle_left); //deg
    ...
    if(1) {
        ...
        TGeoCombiTrans *module0_transform = new TGeoCombiTrans();
            module0_transform->SetTranslation(XModuleShifts[stationNum][0], YModuleShifts[stationNum][0], ZModuleShifts[stationNum][0]+0.5*ZGasSize);
            module0_transform->RotateX(0.89); //deg
            module0_transform->RotateY(-0.23); //deg
            module0_transform->RotateZ(-0.215); //deg
            module0_transform->RotateY(ArmAngle_right); //deg

        TGeoCombiTrans *module1_transform = new TGeoCombiTrans();
            module1_transform->RotateZ(180);
            module1_transform->SetTranslation(XModuleShifts[stationNum][1], YModuleShifts[stationNum][1], ZModuleShifts[stationNum][1]+0.5*ZGasSize);
            module1_transform->RotateX(0.89); //deg
            module1_transform->RotateY(-0.23); //deg
            module1_transform->RotateZ(-0.215); //deg
            module1_transform->RotateY(ArmAngle_right); //deg

        TGeoCombiTrans *frame0_transform = new TGeoCombiTrans();
            frame0_transform->SetTranslation(XModuleShifts[stationNum][0], YModuleShifts[stationNum][0], ZModuleShifts[stationNum][0]+0.5*ZGasSize);
            frame0_transform->RotateX(0.89); //deg
            frame0_transform->RotateY(-0.23); //deg
            frame0_transform->RotateZ(-0.215); //deg
            frame0_transform->RotateY(ArmAngle_right); //deg

        TGeoCombiTrans *frame1_transform = new TGeoCombiTrans();
            frame1_transform->RotateZ(180);
            frame1_transform->SetTranslation(XModuleShifts[stationNum][1], YModuleShifts[stationNum][1], ZModuleShifts[stationNum][1]+0.5*ZGasSize);
            frame1_transform->RotateX(0.89); //deg
            frame1_transform->RotateY(-0.23); //deg
            frame1_transform->RotateZ(-0.215); //deg
            frame1_transform->RotateY(ArmAngle_right); //deg
