...
// const Double_t XStationPositions[NStations] = { 3.8175+43.707/*-43.707+0.5*//*0*/, -110.0/*1*/, 130.0/*2*/, -130.0/*3*/}; //geometry center
// const Double_t YStationPositions[NStations] = { 3.7785+0.511/*0.511-4.7*//*0*/, 0.0/*1*/, 0.0/*2*/, 0.0/*3*/}; //geometry center
// const Double_t ZStationPositions[NStations] = { -576.2 + 1002.094/*1001.132-576.2*//*0*/, 410.0/*1*/, 470.0/*2*/, 470.0/*3*/}; //outer side nearest to the target
const Double_t XStationPositions[NStations] = { 0./*-43.707+0.5*//*0*/, -110.0/*1*/, 130.0/*2*/, -130.0/*3*/}; //geometry center
const Double_t YStationPositions[NStations] = { 0./*0.511-4.7*//*0*/, 0.0/*1*/, 0.0/*2*/, 0.0/*3*/}; //geometry center
const Double_t ZStationPositions[NStations] = { -576.2 + TMath::Sqrt(10020.94 * 10020.94  - 437.07 * 437.07 - 5.11 * 5.11) * 0.1/*1001.132-576.2*//*0*/, 410.0/*1*/, 470.0/*2*/, 470.0/*3*/}; //outer side nearest to the target
...
void create_rootgeom_CSC_RunSRC2021_After_Magnet() {
    ...
    const TString geoDetectorVersion = "RunSRCSpring2022";//"Run8_SRC_detailed";
