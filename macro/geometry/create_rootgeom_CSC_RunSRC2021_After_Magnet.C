...
// SP-57 Magnet Center Positions in BM@N System Coordinate
const Double_t X_SP57 = 0.5055 - 0.167 + 7.-3.521, Y_SP57 = -4.62 - 20.53 + 5. + 19.+4.9285, Z_SP57 = -576.2;

// SP-57 Shifts for Single CSC Center regarding SP-57 Magnet Center from measurements 
const Double_t CSC_SP_57_X_Shift = 437.07 * 0.1, CSC_SP_57_Y_Shift = 5.11 * 0.1, CSC_SP_57_Distance_Shift = 10020.94 * 0.1;

//(X-Y-Z)Positions of stations
const Double_t XStationPositions[NStations] = { X_SP57 + CSC_SP_57_X_Shift/*-43.707+0.5*//*0*/, -110.0/*1*/, 130.0/*2*/, -130.0/*3*/}; //geometry center
const Double_t YStationPositions[NStations] = { Y_SP57 + CSC_SP_57_Y_Shift/*0.511-4.7*//*0*/, 0.0/*1*/, 0.0/*2*/, 0.0/*3*/}; //geometry center
const Double_t ZStationPositions[NStations] = { Z_SP57 + TMath::Sqrt(CSC_SP_57_Distance_Shift * CSC_SP_57_Distance_Shift  - CSC_SP_57_X_Shift * CSC_SP_57_X_Shift - CSC_SP_57_Y_Shift * CSC_SP_57_Y_Shift)/*1001.132-576.2*//*0*/, 410.0/*1*/, 470.0/*2*/, 470.0/*3*/}; //outer side nearest to the target
...
void create_rootgeom_CSC_RunSRC2021_After_Magnet() {
    ...
    const TString geoDetectorVersion = "RunSRCSpring2022_For_Yaopeng";//"Run8_SRC_detailed";
