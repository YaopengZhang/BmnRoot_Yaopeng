...
const double ArmLength_left = 113.033;
const double ArmAngle_left = 30.53;
const double ArmLength_right = 111.832;
const double ArmAngle_right = -30.87;
...
const Double_t XStationPositions[NStations] = {
    ArmLength_left*sin(ArmAngle_left/180.*TMath::Pi()) + XMagnetPosition /* +61.237 cm */, //station 0 (left-arm GEM)
    ArmLength_right*sin(ArmAngle_right/180.*TMath::Pi()) + XMagnetPosition /* -53.563 cm */ //station 1 (right-arm GEM)
};
const Double_t YStationPositions[NStations] = {
    +0.0 + YMagnetPosition /* +3.7785 cm */, //station 0 (left-arm GEM)
    +0.0 + YMagnetPosition /* +3.7785 cm */  //station 1 (right-arm GEM)
};
const Double_t ZStationPositions[NStations] = {
    ArmLength_left*cos(ArmAngle_left/180.*TMath::Pi()) + ZMagnetPosition /* -478.83752 cm */, //station 0 (left-arm GEM)
    ArmLength_right*cos(ArmAngle_right/180.*TMath::Pi()) + ZMagnetPosition /* -480.21083 cm */  //station 1 (right-arm GEM)
};
// //------------------------------------------------------------------------------
...
const Double_t YModuleShifts[NStations][NMaxModules] = {
    { -0.056 }, //station 0 (left-arm GEM)      align_left_gem_y0 = -0.056
    { 0.003 }  //station 1 (right-arm GEM)      align_right_gem_y0 = 0.003
};
...
void create_rootgeom_GEMS_Yaopeng() {
    ...
    if(1) {
        ...
        TGeoCombiTrans *module0_transform = new TGeoCombiTrans();
            ...
            module0_transform->RotateX(-0.0435); //deg
            module0_transform->RotateY(0.44); //deg
            module0_transform->RotateZ(-0.23); //deg
        ...
        TGeoCombiTrans *frame0_transform = new TGeoCombiTrans();
            ...
            frame0_transform->RotateX(-0.0435); //deg
            frame0_transform->RotateY(0.44); //deg
            frame0_transform->RotateZ(-0.23); //deg
    ...
    if(1) {
        ...
        TGeoCombiTrans *module0_transform = new TGeoCombiTrans();
            ...
            //module0_transform->RotateY(180.0); //deg
            module0_transform->SetTranslation(XModuleShifts[stationNum][0], YModuleShifts[stationNum][0], ZModuleShifts[stationNum][0]+ZModuleSize_Station66x41*0.5);
            module0_transform->RotateX(0.19); //deg
            module0_transform->RotateY(-0.4); //deg
        ...
        TGeoCombiTrans *frame0_transform = new TGeoCombiTrans();
            ...
            //frame0_transform->RotateY(180.0); //deg
            frame0_transform->SetTranslation(XModuleShifts[stationNum][0], YModuleShifts[stationNum][0], ZModuleShifts[stationNum][0]+ZModuleSize_Station66x41*0.5);
            frame0_transform->RotateX(0.19); //deg
            frame0_transform->RotateY(-0.4); //deg
