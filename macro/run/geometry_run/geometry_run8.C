...
void geometry(FairRunSim *fRun)
{
    ...
    scwall->SetGeometryFileName("ScWall_NEW_POSITION_run8_with_hole_in_box_with_hole_Zpos_736.0cm_Xshift_61.50cm_Yshift_0.0cm_rotationY_0.0deg_v1.root");
    ...
    BmnNdet* ndet = new BmnNdet("NDET", kTRUE);
    //FairDetector* zdc = new BmnZdc("ZDC", kTRUE);
    //zdc->SetBirk();

    ndet->SetMappingFile_modules("nDet_mapping_modules_12x12cm_9mods_15sect.txt");
    ndet->SetMappingFile_sections("nDet_mapping_sections_12x12cm_9mods_15sect.txt");

//nDet prototype
    ndet->SetGeometryFileName("nDet_12x12cm_9mods_4x4cm_VETO_25mm_5slices_Pb_8mm_9slices_Cu_30mm_Sc_25mm_G10_5mm_Air_5mm_no_hole_Zpos_780.0cm_Xshift_0.0cm_Yshift_0.0cm_rotationY_0.0deg_v1.root");//nDet at 0 deg.

    //ndet->SetGeometryFileName("nDet_12x12cm_9mods_4x4cm_VETO_25mm_5slices_Pb_8mm_9slices_Cu_30mm_Sc_25mm_G10_5mm_Air_5mm_no_hole_572cm_Zpos_509.7cm_Xshift_-259.70cm_Yshift_0.0cm_rotationY_-27.0deg_v1.root");//nDet at 27 deg.
