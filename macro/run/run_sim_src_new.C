...
#include "macro/run/geometry_run/geometry_src_run8_new.C"
...
void run_sim_src_new(TString inFile = "", TString outFile = "$VMCWORKDIR/macro/run/srcsim_Abs_WF_10Mio_latest.root",
...
*/
    ...
    fRun->CreateGeometryFile("full_geometry_new.root");  // save the full setup geometry to the additional file
