...
// found on file: srcsim_delta_test_frag_highstat.root
//////////////////////////////////////////////////////////

#ifndef Read_srcsim_delta_test_frag_highstat_h
#define Read_srcsim_delta_test_frag_highstat_h
...
class Read_srcsim_delta_test_frag_highstat {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxbmnroot_0_Stack_MCTrack = 31;
   static constexpr Int_t kMaxbmnroot_0_STS_StsPoint = 9;
   static constexpr Int_t kMaxbmnroot_0_CSC_CSCPoint = 13;
   static constexpr Int_t kMaxbmnroot_0_TOF1_TOF400Point = 28;
   static constexpr Int_t kMaxbmnroot_0_Event_MCEventHeader = 1;
   static constexpr Int_t kMaxbmnroot_0_MCGeoTrack_GeoTracks = 1419;
   ...
   Read_srcsim_delta_test_frag_highstat(TTree *tree=0);
   virtual ~Read_srcsim_delta_test_frag_highstat();
...
#ifdef Read_srcsim_delta_test_frag_highstat_cxx
Read_srcsim_delta_test_frag_highstat::Read_srcsim_delta_test_frag_highstat(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_delta_test_frag_highstat.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("srcsim_delta_test_frag_highstat.root");
      }
      // f->GetObject("bmndata",tree);
      // TFile *f2 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_delta_test_frag_highstat_1.root");
      // if (!f2 || !f2->IsOpen()) {
      //    f2 = new TFile("srcsim_delta_test_frag_highstat_1.root");
      // }
      ...
      chain->Add("srcsim_delta_test_frag_highstat.root");
      // chain->Add("srcsim_delta_test_frag_highstat_1.root");
...
Read_srcsim_delta_test_frag_highstat::~Read_srcsim_delta_test_frag_highstat()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Read_srcsim_delta_test_frag_highstat::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Read_srcsim_delta_test_frag_highstat::LoadTree(Long64_t entry)
{
...
void Read_srcsim_delta_test_frag_highstat::Init(TTree *tree)
{
...
Bool_t Read_srcsim_delta_test_frag_highstat::Notify()
{
...
void Read_srcsim_delta_test_frag_highstat::Show(Long64_t entry)
{
...
Int_t Read_srcsim_delta_test_frag_highstat::Cut(Long64_t entry)
{
...
#endif // #ifdef Read_srcsim_delta_test_frag_highstat_cxx
