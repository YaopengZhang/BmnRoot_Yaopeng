#define Read_srcsim_v1p2_5Mio_cxx
#include "Read_srcsim_v1p2_5Mio.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
Double_t Read_srcsim_v1p2_5Mio::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_v1p2_5Mio.C
//      root> Read_srcsim_v1p2_5Mio t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   ch_vertex.Add("vertex_v1p2_5Mio.root");
   ...
   TFile *file_output_QE = new TFile("./QE_Simulation_v1p2_5Mio.root","RECREATE"); // "UPDATE"
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      // ch.GetEntry(jentry);
      weight = events[jentry].W;
      P1x = events[jentry].P3[0];
      P1y = events[jentry].P3[1];
      P1z = events[jentry].P3[2];
      P2x = events[jentry].P4[0];
      P2y = events[jentry].P4[1];
      P2z = events[jentry].P4[2];
      PBx = events[jentry].Am1[0];
      PBy = events[jentry].Am1[1];
      PBz = events[jentry].Am1[2];
      if(P1x>0){
         px_left_initial = P1x;
         py_left_initial = P1y;
         pz_left_initial = P1z;
   ...
   TFile *My_output = new TFile("./my_output_v1p2_5Mio.root", "RECREATE");
   h_vertex_z->Write();
   h_p1x->Write();
   h_p1y->Write();
   h_p1z->Write();
   ...
   TFile *My_output_generator = new TFile("./my_output_generator_v1p2_5Mio.root", "RECREATE");
   h_p1x_1->Write();
   h_p1y_1->Write();
   h_p1z_1->Write();
   h_E1_1->Write();
