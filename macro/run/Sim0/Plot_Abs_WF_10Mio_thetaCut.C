#include "Read_srcsim_Abs_WF_10Mio_thetaCut.C"

void Plot_Abs_WF_10Mio_thetaCut(){
    Read_srcsim_Abs_WF_10Mio_thetaCut t;
    ...
    // t.Loop(0.,110.); // Boost_resolution, TOF_resolution *
    // t.Loop(0.,120.); // Boost_resolution, TOF_resolution
    // t.Loop(0.,130.); // Boost_resolution, TOF_resolution
    // t.Loop(0.,140.); // Boost_resolution, TOF_resolution *
    // t.Loop(0.,150.); // Boost_resolution, TOF_resolution
    // t.Loop(0.,160.); // Boost_resolution, TOF_resolution
    // t.Loop(0.,170.); // Boost_resolution, TOF_resolution *
    // t.Loop(0.,0.); // Boost_resolution, TOF_resolution *
    // t.Loop(0.,180.); // Boost_resolution, TOF_resolution
    // t.Loop(0.,190.); // Boost_resolution, TOF_resolution
    // t.Loop(0.,220.); // Boost_resolution, TOF_resolution *
}
