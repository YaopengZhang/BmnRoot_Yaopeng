#define alexei_xsKammerud_abs_cxx
#include "alexei_xsKammerud_abs.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void alexei_xsKammerud_abs::Loop()
{
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile *f = new TFile("./vertex_alexei_xsKammerud_abs.root","RECREATE"); // "UPDATE"
   ...
   ofstream OUT("Generator_input_alexei_xsKammerud_abs.txt"); // Generate the input file for FairAsciiGenerator
