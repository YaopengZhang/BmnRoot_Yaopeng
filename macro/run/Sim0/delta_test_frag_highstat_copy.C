...
void delta_test_frag_highstat_copy(){
    ...
    // TFile *f = new TFile("./vertex_delta_test_frag_highstat.root","RECREATE"); // "UPDATE"
    ...
    // TFile *f_gen = new TFile("./gen_delta_test_frag_highstat.root","RECREATE"); // "UPDATE"
    ...
    // ofstream OUT("Generator_input_delta_test_frag_highstat.txt"); // Generate the input file for FairAsciiGenerator
    // ofstream OUT_delta("Delta_events_delta_test_frag_highstat.txt"); 
    // ofstream OUT_delta_11B("Delta_events_delta_test_frag_highstat_11B.txt"); 
    ...
    std::string directoryPath = "./DropMeFiles_5sCTR/";
