#define v1p2_50Mio_cxx
#include "v1p2_50Mio.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void v1p2_50Mio::Loop()
{
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   // First 15 input files: 3175428
   // First 16 input files: 4233118
   // The 16th input file: 1057690
   // 3175428-4233118
   Long64_t nentries = fChain->GetEntries(); // 20110073
   cout<<nentries<<endl;
   ...
   // TFile *f = new TFile("./vertex_v1p2_50Mio.root","RECREATE"); // "UPDATE"
   ...
   // ofstream OUT("Generator_input_v1p2_50Mio.txt"); // Generate the input file for FairAsciiGenerator
