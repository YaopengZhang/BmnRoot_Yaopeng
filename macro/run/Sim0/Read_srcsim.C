...
const double Mmiss2Mean = 8.45866e-01;
...
Double_t Read_srcsim::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   ch.SetBranchAddress("PBx",&PBx);
   ch.SetBranchAddress("PBy",&PBy);
   ch.SetBranchAddress("PBz_lab",&PBz);
   ...
   Double_t NormFactor = 5549; // No beta cut
   ...
   TFile *My_output = new TFile("./my_output.root", "RECREATE");
   h_vertex_z->Write();
   ...
   TFile *My_output_generator = new TFile("./my_output_generator.root", "RECREATE");
   h_p1x_1->Write();
   h_p1y_1->Write();
   h_p1z_1->Write();
   h_E1_1->Write();
