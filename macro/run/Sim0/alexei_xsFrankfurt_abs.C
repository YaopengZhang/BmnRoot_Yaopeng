#define alexei_xsFrankfurt_abs_cxx
#include "alexei_xsFrankfurt_abs.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void alexei_xsFrankfurt_abs::Loop()
{
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile *f = new TFile("./vertex_alexei_xsFrankfurt_abs.root","RECREATE"); // "UPDATE"
   ...
   ofstream OUT("Generator_input_alexei_xsFrankfurt_abs.txt"); // Generate the input file for FairAsciiGenerator
