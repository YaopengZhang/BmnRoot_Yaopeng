#define alexei_xsKammerud_cxx
#include "alexei_xsKammerud.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void alexei_xsKammerud::Loop()
{
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile *f = new TFile("./vertex_alexei_xsKammerud.root","RECREATE"); // "UPDATE"
   ...
   ofstream OUT("Generator_input_alexei_xsKammerud.txt"); // Generate the input file for FairAsciiGenerator
