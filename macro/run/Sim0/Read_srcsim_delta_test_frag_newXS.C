#define Read_srcsim_delta_test_frag_newXS_cxx
#include "Read_srcsim_delta_test_frag_newXS.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
//    TVector3 vec2(0, 1, 0);
//    cout<<If_delta(4, vec1, vec2, "Delta_events_delta_test_frag_newXS.txt")<<endl;
// }

Double_t Read_srcsim_delta_test_frag_newXS::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_delta_test_frag_newXS.C
//      root> Read_srcsim_delta_test_frag_newXS t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TChain ch("T");
   ch.Add("gen_delta_test_frag_newXS.root");
   ...
   ch_vertex.Add("vertex_delta_test_frag_newXS.root");
   ...
   std::ifstream file("Delta_events_delta_test_frag_newXS_11B.txt");
   if (!file.is_open()) {
      std::cerr << "Can't open the input file!" << std::endl;
      return -1;
   }
   ...
   std::ifstream file_delta("Delta_events_delta_test_frag_newXS.txt");
   ...
   // 38
   TH1F *h_M_miss_square_frag_newXS_with_accp = new TH1F("M_miss_square_frag_newXS_with_accp","M^{2}_{ miss }",60,0.08,2);
   TH1F *h_M_miss_square_frag_newXS = new TH1F("M_miss_square_frag_newXS","M^{2}_{ miss }",60,0.08,2);
   h_M_miss_square_frag_newXS_with_accp->SetXTitle("M^{2}_{ miss } / GeV");
	h_M_miss_square_frag_newXS_with_accp->GetXaxis()->CenterTitle(1);
	h_M_miss_square_frag_newXS_with_accp->GetXaxis()->SetTitleFont(32);
   h_M_miss_square_frag_newXS_with_accp->GetXaxis()->SetTitleSize(0.06);
	h_M_miss_square_frag_newXS_with_accp->GetXaxis()->SetTitleOffset(0.7);
   h_M_miss_square_frag_newXS_with_accp->SetYTitle("Counts");
	h_M_miss_square_frag_newXS_with_accp->GetYaxis()->CenterTitle(1);
	h_M_miss_square_frag_newXS_with_accp->GetYaxis()->SetTitleFont(32);
   h_M_miss_square_frag_newXS_with_accp->GetYaxis()->SetTitleSize(0.04);

   TH1F *h_P_miss_frag_newXS_with_accp = new TH1F("P_miss_frag_newXS_with_accp","P_{ miss }",70,0,0.7);
   TH1F *h_P_miss_frag_newXS = new TH1F("P_miss_frag_newXS","P_{ miss }",70,0,0.7);
   h_P_miss_frag_newXS_with_accp->SetXTitle("P_{ miss } / GeV");
	h_P_miss_frag_newXS_with_accp->GetXaxis()->CenterTitle(1);
	h_P_miss_frag_newXS_with_accp->GetXaxis()->SetTitleFont(32);
   h_P_miss_frag_newXS_with_accp->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_frag_newXS_with_accp->GetXaxis()->SetTitleOffset(0.7);
   h_P_miss_frag_newXS_with_accp->SetYTitle("Counts");
	h_P_miss_frag_newXS_with_accp->GetYaxis()->CenterTitle(1);
	h_P_miss_frag_newXS_with_accp->GetYaxis()->SetTitleFont(32);
   h_P_miss_frag_newXS_with_accp->GetYaxis()->SetTitleSize(0.04);

   TH1F *h_P_miss_x_frag_newXS_with_accp = new TH1F("P_miss_x_frag_newXS_with_accp","Pmiss_{ x }",100,-1,1);
   TH1F *h_P_miss_x_frag_newXS = new TH1F("P_miss_x_frag_newXS","Pmiss_{ x }",100,-1,1);
   h_P_miss_x_frag_newXS_with_accp->SetXTitle("Pmiss_{ x } / GeV");
	h_P_miss_x_frag_newXS_with_accp->GetXaxis()->CenterTitle(1);
	h_P_miss_x_frag_newXS_with_accp->GetXaxis()->SetTitleFont(32);
   h_P_miss_x_frag_newXS_with_accp->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_x_frag_newXS_with_accp->GetXaxis()->SetTitleOffset(0.7);
   h_P_miss_x_frag_newXS_with_accp->SetYTitle("Counts");
	h_P_miss_x_frag_newXS_with_accp->GetYaxis()->CenterTitle(1);
	h_P_miss_x_frag_newXS_with_accp->GetYaxis()->SetTitleFont(32);
   h_P_miss_x_frag_newXS_with_accp->GetYaxis()->SetTitleSize(0.04);

   TH1F *h_P_miss_y_frag_newXS_with_accp = new TH1F("P_miss_y_frag_newXS_with_accp","Pmiss_{ y }",100,-1,1);
   TH1F *h_P_miss_y_frag_newXS = new TH1F("P_miss_y_frag_newXS","Pmiss_{ y }",100,-1,1);
   h_P_miss_y_frag_newXS_with_accp->SetXTitle("Pmiss_{ y }/ GeV");
	h_P_miss_y_frag_newXS_with_accp->GetXaxis()->CenterTitle(1);
	h_P_miss_y_frag_newXS_with_accp->GetXaxis()->SetTitleFont(32);
   h_P_miss_y_frag_newXS_with_accp->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_y_frag_newXS_with_accp->GetXaxis()->SetTitleOffset(0.7);
   h_P_miss_y_frag_newXS_with_accp->SetYTitle("Counts");
	h_P_miss_y_frag_newXS_with_accp->GetYaxis()->CenterTitle(1);
	h_P_miss_y_frag_newXS_with_accp->GetYaxis()->SetTitleFont(32);
   h_P_miss_y_frag_newXS_with_accp->GetYaxis()->SetTitleSize(0.04);

   TH1F *h_P_miss_z_frag_newXS_with_accp = new TH1F("P_miss_z_frag_newXS_with_accp","Pmiss_{ z }",100,-1,1);
   TH1F *h_P_miss_z_frag_newXS = new TH1F("P_miss_z_frag_newXS","Pmiss_{ z }",100,-1,1);
   h_P_miss_z_frag_newXS_with_accp->SetXTitle("Pmiss_{ z }/ GeV");
	h_P_miss_z_frag_newXS_with_accp->GetXaxis()->CenterTitle(1);
	h_P_miss_z_frag_newXS_with_accp->GetXaxis()->SetTitleFont(32);
   h_P_miss_z_frag_newXS_with_accp->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_z_frag_newXS_with_accp->GetXaxis()->SetTitleOffset(0.7);
   h_P_miss_z_frag_newXS_with_accp->SetYTitle("Counts");
	h_P_miss_z_frag_newXS_with_accp->GetYaxis()->CenterTitle(1);
	h_P_miss_z_frag_newXS_with_accp->GetYaxis()->SetTitleFont(32);
   h_P_miss_z_frag_newXS_with_accp->GetYaxis()->SetTitleSize(0.04);

   // 39
   TH1F *h_M_miss_square_frag_newXS_with_accp_diff = new TH1F("M_miss_square_frag_newXS_with_accp_diff","M^{2}_{ miss } difference between two reconstruction methods",100,-1,1);
   h_M_miss_square_frag_newXS_with_accp_diff->SetXTitle("M^{2}_{ miss } / GeV");
	h_M_miss_square_frag_newXS_with_accp_diff->GetXaxis()->CenterTitle(1);
	h_M_miss_square_frag_newXS_with_accp_diff->GetXaxis()->SetTitleFont(32);
   h_M_miss_square_frag_newXS_with_accp_diff->GetXaxis()->SetTitleSize(0.06);
	h_M_miss_square_frag_newXS_with_accp_diff->GetXaxis()->SetTitleOffset(0.7);
   h_M_miss_square_frag_newXS_with_accp_diff->SetYTitle("Counts");
	h_M_miss_square_frag_newXS_with_accp_diff->GetYaxis()->CenterTitle(1);
	h_M_miss_square_frag_newXS_with_accp_diff->GetYaxis()->SetTitleFont(32);
   h_M_miss_square_frag_newXS_with_accp_diff->GetYaxis()->SetTitleSize(0.04);

   TH1F *h_P_miss_frag_newXS_with_accp_diff = new TH1F("P_miss_frag_newXS_with_accp_diff","P_{ miss } difference between two reconstruction methods",100,-1,1);
   h_P_miss_frag_newXS_with_accp_diff->SetXTitle("P_{ miss } / GeV");
	h_P_miss_frag_newXS_with_accp_diff->GetXaxis()->CenterTitle(1);
	h_P_miss_frag_newXS_with_accp_diff->GetXaxis()->SetTitleFont(32);
   h_P_miss_frag_newXS_with_accp_diff->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_frag_newXS_with_accp_diff->GetXaxis()->SetTitleOffset(0.7);
   h_P_miss_frag_newXS_with_accp_diff->SetYTitle("Counts");
	h_P_miss_frag_newXS_with_accp_diff->GetYaxis()->CenterTitle(1);
	h_P_miss_frag_newXS_with_accp_diff->GetYaxis()->SetTitleFont(32);
   h_P_miss_frag_newXS_with_accp_diff->GetYaxis()->SetTitleSize(0.04);

   TH1F *h_P_miss_x_frag_newXS_with_accp_diff = new TH1F("P_miss_x_frag_newXS_with_accp_diff","Pmiss_{ x } difference between two reconstruction methods",100,-1,1);
   h_P_miss_x_frag_newXS_with_accp_diff->SetXTitle("Pmiss_{ x } / GeV");
	h_P_miss_x_frag_newXS_with_accp_diff->GetXaxis()->CenterTitle(1);
	h_P_miss_x_frag_newXS_with_accp_diff->GetXaxis()->SetTitleFont(32);
   h_P_miss_x_frag_newXS_with_accp_diff->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_x_frag_newXS_with_accp_diff->GetXaxis()->SetTitleOffset(0.7);
   h_P_miss_x_frag_newXS_with_accp_diff->SetYTitle("Counts");
	h_P_miss_x_frag_newXS_with_accp_diff->GetYaxis()->CenterTitle(1);
	h_P_miss_x_frag_newXS_with_accp_diff->GetYaxis()->SetTitleFont(32);
   h_P_miss_x_frag_newXS_with_accp_diff->GetYaxis()->SetTitleSize(0.04);

   TH1F *h_P_miss_y_frag_newXS_with_accp_diff = new TH1F("P_miss_y_frag_newXS_with_accp_diff","Pmiss_{ y } difference between two reconstruction methods",100,-1,1);
   h_P_miss_y_frag_newXS_with_accp_diff->SetXTitle("Pmiss_{ y }/ GeV");
	h_P_miss_y_frag_newXS_with_accp_diff->GetXaxis()->CenterTitle(1);
	h_P_miss_y_frag_newXS_with_accp_diff->GetXaxis()->SetTitleFont(32);
   h_P_miss_y_frag_newXS_with_accp_diff->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_y_frag_newXS_with_accp_diff->GetXaxis()->SetTitleOffset(0.7);
   h_P_miss_y_frag_newXS_with_accp_diff->SetYTitle("Counts");
	h_P_miss_y_frag_newXS_with_accp_diff->GetYaxis()->CenterTitle(1);
	h_P_miss_y_frag_newXS_with_accp_diff->GetYaxis()->SetTitleFont(32);
   h_P_miss_y_frag_newXS_with_accp_diff->GetYaxis()->SetTitleSize(0.04);

   TH1F *h_P_miss_z_frag_newXS_with_accp_diff = new TH1F("P_miss_z_frag_newXS_with_accp_diff","Pmiss_{ z } difference between two reconstruction methods",100,-1,1);
   h_P_miss_z_frag_newXS_with_accp_diff->SetXTitle("Pmiss_{ z }/ GeV");
	h_P_miss_z_frag_newXS_with_accp_diff->GetXaxis()->CenterTitle(1);
	h_P_miss_z_frag_newXS_with_accp_diff->GetXaxis()->SetTitleFont(32);
   h_P_miss_z_frag_newXS_with_accp_diff->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_z_frag_newXS_with_accp_diff->GetXaxis()->SetTitleOffset(0.7);
   h_P_miss_z_frag_newXS_with_accp_diff->SetYTitle("Counts");
	h_P_miss_z_frag_newXS_with_accp_diff->GetYaxis()->CenterTitle(1);
	h_P_miss_z_frag_newXS_with_accp_diff->GetYaxis()->SetTitleFont(32);
   h_P_miss_z_frag_newXS_with_accp_diff->GetYaxis()->SetTitleSize(0.04);

   // 40
   TH2F *h_M_miss_square_frag_newXS_with_accp_vs_method1 = new TH2F("M_miss_square_frag_newXS_with_accp_vs_method1","M^{2}_{ miss } from two reconstruction methods",100,0,2,100,0,2);
   h_M_miss_square_frag_newXS_with_accp_vs_method1->SetXTitle("M^{2}_{ miss } from Fragments / GeV");
	h_M_miss_square_frag_newXS_with_accp_vs_method1->GetXaxis()->CenterTitle(1);
	h_M_miss_square_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleFont(32);
   h_M_miss_square_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleSize(0.06);
	h_M_miss_square_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleOffset(0.7);
   h_M_miss_square_frag_newXS_with_accp_vs_method1->SetYTitle("M^{2}_{ miss } from Protons / GeV");
	h_M_miss_square_frag_newXS_with_accp_vs_method1->GetYaxis()->CenterTitle(1);
	h_M_miss_square_frag_newXS_with_accp_vs_method1->GetYaxis()->SetTitleFont(32);
   h_M_miss_square_frag_newXS_with_accp_vs_method1->GetYaxis()->SetTitleSize(0.04);

   TH2F *h_P_miss_frag_newXS_with_accp_vs_method1 = new TH2F("P_miss_frag_newXS_with_accp_vs_method1","P_{ miss } from two reconstruction methods",70,0,0.7,70,0,0.7);
   h_P_miss_frag_newXS_with_accp_vs_method1->SetYTitle("P_{ miss } from Fragments / GeV");
   h_P_miss_frag_newXS_with_accp_vs_method1->SetXTitle("P_{ miss } from Protons / GeV");
	h_P_miss_frag_newXS_with_accp_vs_method1->GetXaxis()->CenterTitle(1);
	h_P_miss_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleFont(32);
   h_P_miss_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleOffset(0.7);
	h_P_miss_frag_newXS_with_accp_vs_method1->GetYaxis()->CenterTitle(1);
	h_P_miss_frag_newXS_with_accp_vs_method1->GetYaxis()->SetTitleFont(32);
   h_P_miss_frag_newXS_with_accp_vs_method1->GetYaxis()->SetTitleSize(0.04);

   TH2F *h_P_miss_x_frag_newXS_with_accp_vs_method1 = new TH2F("P_miss_x_frag_newXS_with_accp_vs_method1","Pmiss_{ x } from two reconstruction methods",100,-1,1,100,-1,1);
   h_P_miss_x_frag_newXS_with_accp_vs_method1->SetYTitle("Pmiss_{ x } from Fragments / GeV");
   h_P_miss_x_frag_newXS_with_accp_vs_method1->SetXTitle("Pmiss_{ x } from Protons / GeV");
	h_P_miss_x_frag_newXS_with_accp_vs_method1->GetXaxis()->CenterTitle(1);
	h_P_miss_x_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleFont(32);
   h_P_miss_x_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_x_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleOffset(0.7);
	h_P_miss_x_frag_newXS_with_accp_vs_method1->GetYaxis()->CenterTitle(1);
	h_P_miss_x_frag_newXS_with_accp_vs_method1->GetYaxis()->SetTitleFont(32);
   h_P_miss_x_frag_newXS_with_accp_vs_method1->GetYaxis()->SetTitleSize(0.04);

   TH2F *h_P_miss_y_frag_newXS_with_accp_vs_method1 = new TH2F("P_miss_y_frag_newXS_with_accp_vs_method1","Pmiss_{ y } from two reconstruction methods",100,-1,1,100,-1,1);
   h_P_miss_y_frag_newXS_with_accp_vs_method1->SetYTitle("Pmiss_{ y } from Fragments / GeV");
   h_P_miss_y_frag_newXS_with_accp_vs_method1->SetXTitle("Pmiss_{ y } from Protons / GeV");
	h_P_miss_y_frag_newXS_with_accp_vs_method1->GetXaxis()->CenterTitle(1);
	h_P_miss_y_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleFont(32);
   h_P_miss_y_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_y_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleOffset(0.7);
	h_P_miss_y_frag_newXS_with_accp_vs_method1->GetYaxis()->CenterTitle(1);
	h_P_miss_y_frag_newXS_with_accp_vs_method1->GetYaxis()->SetTitleFont(32);
   h_P_miss_y_frag_newXS_with_accp_vs_method1->GetYaxis()->SetTitleSize(0.04);

   TH2F *h_P_miss_z_frag_newXS_with_accp_vs_method1 = new TH2F("P_miss_z_frag_newXS_with_accp_vs_method1","Pmiss_{ z } from two reconstruction methods",100,-1,1,100,-1,1);
   h_P_miss_z_frag_newXS_with_accp_vs_method1->SetYTitle("Pmiss_{ z } from Fragments / GeV");
   h_P_miss_z_frag_newXS_with_accp_vs_method1->SetXTitle("Pmiss_{ z } from Protons / GeV");
	h_P_miss_z_frag_newXS_with_accp_vs_method1->GetXaxis()->CenterTitle(1);
	h_P_miss_z_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleFont(32);
   h_P_miss_z_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleSize(0.06);
	h_P_miss_z_frag_newXS_with_accp_vs_method1->GetXaxis()->SetTitleOffset(0.7);
	h_P_miss_z_frag_newXS_with_accp_vs_method1->GetYaxis()->CenterTitle(1);
	h_P_miss_z_frag_newXS_with_accp_vs_method1->GetYaxis()->SetTitleFont(32);
   h_P_miss_z_frag_newXS_with_accp_vs_method1->GetYaxis()->SetTitleSize(0.04);
   ...
   TH2F* h_Pmiss_diff_ratio_frag_newXS = new TH2F("h_Pmiss_diff_ratio_frag_newXS","(Pmiss_{ frag } - Pmiss_{ arm }) / Pmiss_{ frag } vs. Pmiss_{ frag }",200,0,2,300,-200,100);
   h_Pmiss_diff_ratio_frag_newXS->SetXTitle("Pmiss_{ frag } / GeV");
	h_Pmiss_diff_ratio_frag_newXS->GetXaxis()->CenterTitle(1);
	h_Pmiss_diff_ratio_frag_newXS->GetXaxis()->SetTitleFont(32);
   h_Pmiss_diff_ratio_frag_newXS->GetXaxis()->SetTitleSize(0.06);
	h_Pmiss_diff_ratio_frag_newXS->GetXaxis()->SetTitleOffset(0.7);
   h_Pmiss_diff_ratio_frag_newXS->SetYTitle("Percentage");
	h_Pmiss_diff_ratio_frag_newXS->GetYaxis()->CenterTitle(1);
	h_Pmiss_diff_ratio_frag_newXS->GetYaxis()->SetTitleFont(32);
   h_Pmiss_diff_ratio_frag_newXS->GetYaxis()->SetTitleSize(0.04);
   ...
   TH2F* h_Pmiss_frag_newXS_theta = new TH2F("h_Pmiss_frag_newXS_theta","Pmiss_{ frag } vs. Theta",200,0,100,200,0,2);
   h_Pmiss_frag_newXS_theta->SetXTitle("Theta");
	h_Pmiss_frag_newXS_theta->GetXaxis()->CenterTitle(1);
	h_Pmiss_frag_newXS_theta->GetXaxis()->SetTitleFont(32);
   h_Pmiss_frag_newXS_theta->GetXaxis()->SetTitleSize(0.06);
	h_Pmiss_frag_newXS_theta->GetXaxis()->SetTitleOffset(0.7);
   h_Pmiss_frag_newXS_theta->SetYTitle("Pmiss_{ frag } / GeV");
	h_Pmiss_frag_newXS_theta->GetYaxis()->CenterTitle(1);
	h_Pmiss_frag_newXS_theta->GetYaxis()->SetTitleFont(32);
   h_Pmiss_frag_newXS_theta->GetYaxis()->SetTitleSize(0.04);
   ...
   TFile *file_output_QE = new TFile("./QE_Simulation_delta_test_frag_newXS.root","RECREATE"); // "UPDATE"
   ...
   // for (Long64_t jentry=0; jentry<100;jentry++) {
      ...
      // Double_t P_12C_frag_newXS = gRandom->Gaus(P_12C_Real,P_12C_Real*0.01);
      Double_t P_12C_frag_newXS = P_12C_Real;
      Double_t beta_12C_frag_newXS = P_12C_frag_newXS/m_12C/sqrt(1.+pow(P_12C_frag_newXS/m_12C,2));
      TLorentzRotation boost_frag_newXS;
      boost_frag_newXS.Boost(0,0,-beta_12C_frag_newXS);

      TLorentzVector Frag, Beam, proton_miss, proton_miss_initial;
      Frag.SetXYZM(PBX,PBY,PBZ,m_11B);
      Beam.SetXYZM(0.,0.,P_12C_frag_newXS,m_12C);
      proton_miss_initial = Beam - Frag;
      proton_miss = boost_frag_newXS *proton_miss_initial;
      Double_t M2_frag_newXS = proton_miss.M2();
      Double_t Pmiss_x_frag_newXS = proton_miss.Px();
      Double_t Pmiss_y_frag_newXS = proton_miss.Py();
      Double_t Pmiss_z_frag_newXS = proton_miss.Pz();
      Double_t Pmiss_frag_newXS = sqrt(pow(Pmiss_x_frag_newXS,2)+pow(Pmiss_y_frag_newXS,2)+pow(Pmiss_z_frag_newXS,2));
      h_M_miss_square_frag_newXS->Fill(M2_frag_newXS);
      h_P_miss_frag_newXS->Fill(Pmiss_frag_newXS);
      h_P_miss_x_frag_newXS->Fill(Pmiss_x_frag_newXS);
      h_P_miss_y_frag_newXS->Fill(Pmiss_y_frag_newXS);
      h_P_miss_z_frag_newXS->Fill(Pmiss_z_frag_newXS);
      ...
      if(Flag_left==1&&Flag_right==1){
         ...
         // h_M_miss_square_frag_newXS_with_accp->Fill(M2_frag_newXS);
         // h_P_miss_frag_newXS_with_accp->Fill(Pmiss_frag_newXS);
         // h_P_miss_x_frag_newXS_with_accp->Fill(Pmiss_x_frag_newXS);
         // h_P_miss_y_frag_newXS_with_accp->Fill(Pmiss_y_frag_newXS);
         // h_P_miss_z_frag_newXS_with_accp->Fill(Pmiss_z_frag_newXS);
      ...
      if(Flag_left==1&&Flag_right==1){
         ...
         h_M_miss_square_frag_newXS_with_accp_diff->Fill(M2_frag_newXS-M_miss);
         h_P_miss_frag_newXS_with_accp_diff->Fill(Pmiss_frag_newXS-P_miss);
         h_P_miss_x_frag_newXS_with_accp_diff->Fill(Pmiss_x_frag_newXS-P_miss_x);
         h_P_miss_y_frag_newXS_with_accp_diff->Fill(Pmiss_y_frag_newXS-P_miss_y);
         h_P_miss_z_frag_newXS_with_accp_diff->Fill(Pmiss_z_frag_newXS-P_miss_z);

         h_Pmiss_diff_ratio->Fill((Pmiss_frag_newXS-P_miss)/Pmiss_frag_newXS*100.);
         h_Pmiss_diff_ratio_frag_newXS->Fill(Pmiss_frag_newXS,(Pmiss_frag_newXS-P_miss)/Pmiss_frag_newXS*100.);
         h_Pmiss_diff_ratio_arm->Fill(P_miss,(Pmiss_frag_newXS-P_miss)/Pmiss_frag_newXS*100.);
         h_Pmiss_frag_newXS_theta->Fill(angle_deg,Pmiss_frag_newXS);
         h_Pmiss_arm_theta->Fill(angle_deg,P_miss);

         h_M_miss_square_frag_newXS_with_accp_vs_method1->Fill(M2_frag_newXS,M_miss);
         // h_P_miss_frag_newXS_with_accp_vs_method1->Fill(Pmiss_frag_newXS,P_miss);
         // h_P_miss_x_frag_newXS_with_accp_vs_method1->Fill(Pmiss_x_frag_newXS,P_miss_x);
         // h_P_miss_y_frag_newXS_with_accp_vs_method1->Fill(Pmiss_y_frag_newXS,P_miss_y);
         // h_P_miss_z_frag_newXS_with_accp_vs_method1->Fill(Pmiss_z_frag_newXS,P_miss_z);
         h_P_miss_frag_newXS_with_accp_vs_method1->Fill(P_miss,Pmiss_frag_newXS);
         h_P_miss_x_frag_newXS_with_accp_vs_method1->Fill(P_miss_x,Pmiss_x_frag_newXS);
         h_P_miss_y_frag_newXS_with_accp_vs_method1->Fill(P_miss_y,Pmiss_y_frag_newXS);
         h_P_miss_z_frag_newXS_with_accp_vs_method1->Fill(P_miss_z,Pmiss_z_frag_newXS);
         //--Comparation between reconstruction form fragments and reconstruction form protons
   ...
   TFile *My_output = new TFile("./my_output_delta_test_frag_newXS.root", "RECREATE");
   h_vertex_z->Write();
   ...
   TFile *My_output_generator = new TFile("./my_output_generator_delta_test_frag_newXS.root", "RECREATE");
   h_p1x_1->Write();
   h_p1y_1->Write();
   h_p1z_1->Write();
   h_E1_1->Write();
   ...
   TCanvas *c_M_miss_square_frag_newXS = new TCanvas("c_M_miss_square_frag_newXS","M_miss_square_frag_newXS",1200,800);
   gStyle->SetOptFit(11);
   gStyle->SetOptStat(11);
   h_M_miss_square_frag_newXS_with_accp->SetLineColor(4);
   h_M_miss_square_frag_newXS_with_accp->Draw();
   // h_M_miss_square_frag_newXS_with_accp->SetNormFactor(8478);
   // h_M_miss_square_frag_newXS_with_accp->Fit("gaus","","SAME",0.6,0.85);
   h_M_miss_square->SetLineColor(1);
   h_M_miss_square->Draw("Same");
   // h_M_miss_square->SetNormFactor(8478);
   // h_M_miss_square_frag_newXS->Fit("gaus","","SAME",0.5,0.9);
   // h_M_miss_square_frag_newXS->GetYaxis()->SetRangeUser(0,190*NormFactor/1243.);
   if(Experiment_Flag==1){
	...
	TLegend *l_M_miss_square_frag_newXS = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_M_miss_square_frag_newXS->SetFillColor(0);
	l_M_miss_square_frag_newXS->SetBorderSize(1);
	l_M_miss_square_frag_newXS->SetTextSize(0.03);
	l_M_miss_square_frag_newXS->SetTextFont(32);
   // l_M_miss_square_frag_newXS->AddEntry(h_M_miss_square,"Fragments - all","l");
   l_M_miss_square_frag_newXS->AddEntry(h_M_miss_square,"Protons","l");
   l_M_miss_square_frag_newXS->AddEntry(h_M_miss_square_frag_newXS_with_accp,"Fragments - accp","l");
   if(Experiment_Flag==1){
      l_M_miss_square_frag_newXS->AddEntry(h_M_miss_square_exp,"Experiment July 30","l");
   }
   l_M_miss_square_frag_newXS->Draw();
   c_M_miss_square_frag_newXS->SaveAs(Form("./reco_plot_%3.1f_%2.0f/38_M_miss_square_frag_newXS.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_frag_newXS = new TCanvas("c_P_miss_frag_newXS","P_miss_frag_newXS",1200,800);
   gStyle->SetOptFit(11);
   gStyle->SetOptStat(11);
   h_P_miss_frag_newXS_with_accp->SetLineColor(4);
   h_P_miss_frag_newXS_with_accp->Draw();
   // h_P_miss_frag_newXS_with_accp->SetNormFactor(8478);
   // h_P_miss_frag_newXS_with_accp->Fit("gaus","","SAME",0.6,0.85);
   h_P_miss_frag_newXS_with_accp->GetYaxis()->SetRangeUser(0,NormFactor/10.*0.7);
   h_P_miss->SetLineColor(1);
   h_P_miss->Draw("Same");
   // h_P_miss_frag_newXS->SetNormFactor(8478);
   // h_P_miss_frag_newXS->Fit("gaus","","SAME",0.5,0.9);
   if(Experiment_Flag==1){
	...
	TLegend *l_P_miss_frag_newXS = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_frag_newXS->SetFillColor(0);
	l_P_miss_frag_newXS->SetBorderSize(1);
	l_P_miss_frag_newXS->SetTextSize(0.03);
	l_P_miss_frag_newXS->SetTextFont(32);
   l_P_miss_frag_newXS->AddEntry(h_P_miss,"Protons","l");
   l_P_miss_frag_newXS->AddEntry(h_P_miss_frag_newXS_with_accp,"Fragments - accp","l");
   if(Experiment_Flag==1){
      l_P_miss_frag_newXS->AddEntry(h_P_miss_exp,"Experiment July 30","l");
   }
   l_P_miss_frag_newXS->Draw();
   c_P_miss_frag_newXS->SaveAs(Form("./reco_plot_%3.1f_%2.0f/38_P_miss_frag_newXS.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_x_frag_newXS = new TCanvas("c_P_miss_x_frag_newXS","P_miss_x_frag_newXS",1200,800);
   gStyle->SetOptFit(11);
   gStyle->SetOptStat(11);
   h_P_miss_x_frag_newXS_with_accp->SetLineColor(4);
   h_P_miss_x_frag_newXS_with_accp->Draw();
   // h_P_miss_x_frag_newXS_with_accp->SetNormFactor(8478);
   // h_P_miss_x_frag_newXS_with_accp->Fit("gaus","","SAME",0.6,0.85);
   h_p1xp2x->SetLineColor(1);
   h_p1xp2x->Draw("Same");
   // h_P_miss_x_frag_newXS->SetNormFactor(8478);
   // h_P_miss_x_frag_newXS->Fit("gaus","","SAME",0.5,0.9);
   // h_P_miss_x_frag_newXS->GetYaxis()->SetRangeUser(0,190*NormFactor/1243.);
   if(Experiment_Flag==1){
	...
	TLegend *l_P_miss_x_frag_newXS = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_x_frag_newXS->SetFillColor(0);
	l_P_miss_x_frag_newXS->SetBorderSize(1);
	l_P_miss_x_frag_newXS->SetTextSize(0.03);
	l_P_miss_x_frag_newXS->SetTextFont(32);
   l_P_miss_x_frag_newXS->AddEntry(h_p1xp2x,"Protons","l");
   l_P_miss_x_frag_newXS->AddEntry(h_P_miss_x_frag_newXS_with_accp,"Fragments - accp","l");
   if(Experiment_Flag==1){
      l_P_miss_x_frag_newXS->AddEntry(h_P_miss_x_exp,"Experiment July 30","l");
   }
   l_P_miss_x_frag_newXS->Draw();
   c_P_miss_x_frag_newXS->SaveAs(Form("./reco_plot_%3.1f_%2.0f/38_P_miss_x_frag_newXS.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_y_frag_newXS = new TCanvas("c_P_miss_y_frag_newXS","P_miss_y_frag_newXS",1200,800);
   gStyle->SetOptFit(11);
   gStyle->SetOptStat(11);
   h_P_miss_y_frag_newXS_with_accp->SetLineColor(4);
   h_P_miss_y_frag_newXS_with_accp->Draw();
   // h_P_miss_y_frag_newXS_with_accp->SetNormFactor(8478);
   // h_P_miss_y_frag_newXS_with_accp->Fit("gaus","","SAME",0.6,0.85);
   h_p1yp2y->SetLineColor(1);
   h_p1yp2y->Draw("Same");
   // h_P_miss_y_frag_newXS->SetNormFactor(8478);
   // h_P_miss_y_frag_newXS->Fit("gaus","","SAME",0.5,0.9);
   // h_P_miss_y_frag_newXS->GetYaxis()->SetRangeUser(0,190*NormFactor/1243.);
   if(Experiment_Flag==1){
	...
	TLegend *l_P_miss_y_frag_newXS = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_y_frag_newXS->SetFillColor(0);
	l_P_miss_y_frag_newXS->SetBorderSize(1);
	l_P_miss_y_frag_newXS->SetTextSize(0.03);
	l_P_miss_y_frag_newXS->SetTextFont(32);
   l_P_miss_y_frag_newXS->AddEntry(h_p1yp2y,"Protons","l");
   l_P_miss_y_frag_newXS->AddEntry(h_P_miss_y_frag_newXS_with_accp,"Fragments - accp","l");
   if(Experiment_Flag==1){
      l_P_miss_y_frag_newXS->AddEntry(h_P_miss_y_exp,"Experiment July 30","l");
   }
   l_P_miss_y_frag_newXS->Draw();
   c_P_miss_y_frag_newXS->SaveAs(Form("./reco_plot_%3.1f_%2.0f/38_P_miss_y_frag_newXS.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_z_frag_newXS = new TCanvas("c_P_miss_z_frag_newXS","P_miss_z_frag_newXS",1200,800);
   gStyle->SetOptFit(11);
   gStyle->SetOptStat(11);
   h_P_miss_z_frag_newXS_with_accp->SetLineColor(4);
   h_P_miss_z_frag_newXS_with_accp->Draw();
   // h_P_miss_z_frag_newXS_with_accp->SetNormFactor(8478);
   // h_P_miss_z_frag_newXS_with_accp->Fit("gaus","","SAME",0.6,0.85);
   h_P_miss_z_frag_newXS_with_accp->GetYaxis()->SetRangeUser(0,NormFactor/10.*1.2);
   h_p1zp2z->SetLineColor(1);
   h_p1zp2z->Draw("Same");
   // h_P_miss_z_frag_newXS->SetNormFactor(8478);
   // h_P_miss_z_frag_newXS->Fit("gaus","","SAME",0.5,0.9);
   // h_P_miss_z_frag_newXS->GetYaxis()->SetRangeUser(0,190*NormFactor/1243.);
   if(Experiment_Flag==1){
	...
	TLegend *l_P_miss_z_frag_newXS = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_z_frag_newXS->SetFillColor(0);
	l_P_miss_z_frag_newXS->SetBorderSize(1);
	l_P_miss_z_frag_newXS->SetTextSize(0.03);
	l_P_miss_z_frag_newXS->SetTextFont(32);
   l_P_miss_z_frag_newXS->AddEntry(h_p1zp2z,"Protons","l");
   l_P_miss_z_frag_newXS->AddEntry(h_P_miss_z_frag_newXS_with_accp,"Fragments - accp","l");
   if(Experiment_Flag==1){
      l_P_miss_z_frag_newXS->AddEntry(h_P_miss_z_exp,"Experiment July 30","l");
   }
   l_P_miss_z_frag_newXS->Draw();
   c_P_miss_z_frag_newXS->SaveAs(Form("./reco_plot_%3.1f_%2.0f/38_P_miss_z_frag_newXS.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_M_miss_square_frag_newXS_diff = new TCanvas("c_M_miss_square_frag_newXS_diff","M_miss_square_frag_newXS_diff",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_M_miss_square_frag_newXS_with_accp_diff->SetLineColor(4);
   h_M_miss_square_frag_newXS_with_accp_diff->Draw();
   c_M_miss_square_frag_newXS_diff->SaveAs(Form("./reco_plot_%3.1f_%2.0f/39_M_miss_square_frag_newXS_diff.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_frag_newXS_diff = new TCanvas("c_P_miss_frag_newXS_diff","P_miss_frag_newXS_diff",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_frag_newXS_with_accp_diff->SetLineColor(4);
   h_P_miss_frag_newXS_with_accp_diff->Draw();
   c_P_miss_frag_newXS_diff->SaveAs(Form("./reco_plot_%3.1f_%2.0f/39_P_miss_frag_newXS_diff.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_x_frag_newXS_diff = new TCanvas("c_P_miss_x_frag_newXS_diff","P_miss_x_frag_newXS_diff",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_x_frag_newXS_with_accp_diff->SetLineColor(4);
   h_P_miss_x_frag_newXS_with_accp_diff->Draw();
   c_P_miss_x_frag_newXS_diff->SaveAs(Form("./reco_plot_%3.1f_%2.0f/39_P_miss_x_frag_newXS_diff.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_y_frag_newXS_diff = new TCanvas("c_P_miss_y_frag_newXS_diff","P_miss_y_frag_newXS_diff",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_y_frag_newXS_with_accp_diff->SetLineColor(4);
   h_P_miss_y_frag_newXS_with_accp_diff->Draw();
   c_P_miss_y_frag_newXS_diff->SaveAs(Form("./reco_plot_%3.1f_%2.0f/39_P_miss_y_frag_newXS_diff.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_z_frag_newXS_diff = new TCanvas("c_P_miss_z_frag_newXS_diff","P_miss_z_frag_newXS_diff",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_z_frag_newXS_with_accp_diff->SetLineColor(4);
   h_P_miss_z_frag_newXS_with_accp_diff->Draw();
   c_P_miss_z_frag_newXS_diff->SaveAs(Form("./reco_plot_%3.1f_%2.0f/39_P_miss_z_frag_newXS_diff.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_M_miss_square_frag_newXS_vs_method1 = new TCanvas("c_M_miss_square_frag_newXS_vs_method1","M_miss_square_frag_newXS_vs_method1",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_M_miss_square_frag_newXS_with_accp_vs_method1->SetLineColor(4);
   h_M_miss_square_frag_newXS_with_accp_vs_method1->Draw("COLZ");
   c_M_miss_square_frag_newXS_vs_method1->SaveAs(Form("./reco_plot_%3.1f_%2.0f/40_M_miss_square_frag_newXS_vs_method1.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_frag_newXS_vs_method1 = new TCanvas("c_P_miss_frag_newXS_vs_method1","P_miss_frag_newXS_vs_method1",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_frag_newXS_with_accp_vs_method1->SetLineColor(4);
   h_P_miss_frag_newXS_with_accp_vs_method1->Draw("COLZ");
   c_P_miss_frag_newXS_vs_method1->SaveAs(Form("./reco_plot_%3.1f_%2.0f/40_P_miss_frag_newXS_vs_method1.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_x_frag_newXS_vs_method1 = new TCanvas("c_P_miss_x_frag_newXS_vs_method1","P_miss_x_frag_newXS_vs_method1",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_x_frag_newXS_with_accp_vs_method1->SetLineColor(4);
   h_P_miss_x_frag_newXS_with_accp_vs_method1->Draw("COLZ");
   c_P_miss_x_frag_newXS_vs_method1->SaveAs(Form("./reco_plot_%3.1f_%2.0f/40_P_miss_x_frag_newXS_vs_method1.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_y_frag_newXS_vs_method1 = new TCanvas("c_P_miss_y_frag_newXS_vs_method1","P_miss_y_frag_newXS_vs_method1",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_y_frag_newXS_with_accp_vs_method1->SetLineColor(4);
   h_P_miss_y_frag_newXS_with_accp_vs_method1->Draw("COLZ");
   c_P_miss_y_frag_newXS_vs_method1->SaveAs(Form("./reco_plot_%3.1f_%2.0f/40_P_miss_y_frag_newXS_vs_method1.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_z_frag_newXS_vs_method1 = new TCanvas("c_P_miss_z_frag_newXS_vs_method1","P_miss_z_frag_newXS_vs_method1",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_z_frag_newXS_with_accp_vs_method1->SetLineColor(4);
   h_P_miss_z_frag_newXS_with_accp_vs_method1->Draw("COLZ");
   c_P_miss_z_frag_newXS_vs_method1->SaveAs(Form("./reco_plot_%3.1f_%2.0f/40_P_miss_z_frag_newXS_vs_method1.pdf",Boost_resolution,TOF_resolution));
   ...
   // 42
   TCanvas *c_P_miss_frag_newXS_new = new TCanvas("c_P_miss_frag_newXS_new","P_miss_frag_newXS_new",1200,800);
   gStyle->SetOptFit(11);
   gStyle->SetOptStat(11);
   h_P_miss_frag_newXS_with_accp->SetLineColor(4);
   h_P_miss_frag_newXS_with_accp->Draw();
   // h_P_miss_frag_newXS_with_accp->SetNormFactor(8478);
   // h_P_miss_frag_newXS_with_accp->Fit("gaus","","SAME",0.6,0.85);
   h_P_miss_frag_newXS_with_accp->GetYaxis()->SetRangeUser(0,N_Sim/10.*0.7);
   h_P_miss->SetLineColor(1);
   h_P_miss->Draw("Same");
   h1->SetLineColor(6);
   h1->Draw("Same");
   ...
   h5->SetNormFactor(N_Sim);
	TLegend *l_P_miss_frag_newXS_new = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_frag_newXS_new->SetFillColor(0);
	l_P_miss_frag_newXS_new->SetBorderSize(1);
	l_P_miss_frag_newXS_new->SetTextSize(0.03);
	l_P_miss_frag_newXS_new->SetTextFont(32);
   l_P_miss_frag_newXS_new->AddEntry(h_P_miss,"Arm-Sim","l");
   l_P_miss_frag_newXS_new->AddEntry(h_P_miss_frag_newXS_with_accp,"Frag-Sim","l");
   l_P_miss_frag_newXS_new->AddEntry(h5,"Arm-Data","l");
   l_P_miss_frag_newXS_new->AddEntry(h1,"Frag-Data","l");
   l_P_miss_frag_newXS_new->Draw();
   c_P_miss_frag_newXS_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/42_P_miss_frag_newXS.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_x_frag_newXS_new = new TCanvas("c_P_miss_x_frag_newXS_new","P_miss_x_frag_newXS_new",1200,800);
   gStyle->SetOptFit(11);
   gStyle->SetOptStat(11);
   h_P_miss_x_frag_newXS_with_accp->SetLineColor(4);
   h_P_miss_x_frag_newXS_with_accp->Draw();
   ...
   h6->SetNormFactor(N_Sim);
	TLegend *l_P_miss_x_frag_newXS_new = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_x_frag_newXS_new->SetFillColor(0);
	l_P_miss_x_frag_newXS_new->SetBorderSize(1);
	l_P_miss_x_frag_newXS_new->SetTextSize(0.03);
	l_P_miss_x_frag_newXS_new->SetTextFont(32);
   l_P_miss_x_frag_newXS_new->AddEntry(h_P_miss,"Arm-Sim","l");
   l_P_miss_x_frag_newXS_new->AddEntry(h_P_miss_frag_newXS_with_accp,"Frag-Sim","l");
   l_P_miss_x_frag_newXS_new->AddEntry(h6,"Arm-Data","l");
   l_P_miss_x_frag_newXS_new->AddEntry(h2,"Frag-Data","l");
   l_P_miss_x_frag_newXS_new->Draw();
   c_P_miss_x_frag_newXS_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/42_P_miss_x_frag_newXS.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_y_frag_newXS_new = new TCanvas("c_P_miss_y_frag_newXS_new","P_miss_y_frag_newXS_new",1200,800);
   gStyle->SetOptFit(11);
   gStyle->SetOptStat(11);
   h_P_miss_y_frag_newXS_with_accp->SetLineColor(4);
   h_P_miss_y_frag_newXS_with_accp->Draw();
   ...
   h7->SetNormFactor(N_Sim);
	TLegend *l_P_miss_y_frag_newXS_new = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_y_frag_newXS_new->SetFillColor(0);
	l_P_miss_y_frag_newXS_new->SetBorderSize(1);
	l_P_miss_y_frag_newXS_new->SetTextSize(0.03);
	l_P_miss_y_frag_newXS_new->SetTextFont(32);
   l_P_miss_y_frag_newXS_new->AddEntry(h_P_miss,"Arm-Sim","l");
   l_P_miss_y_frag_newXS_new->AddEntry(h_P_miss_frag_newXS_with_accp,"Frag-Sim","l");
   l_P_miss_y_frag_newXS_new->AddEntry(h7,"Arm-Data","l");
   l_P_miss_y_frag_newXS_new->AddEntry(h3,"Frag-Data","l");
   l_P_miss_y_frag_newXS_new->Draw();
   c_P_miss_y_frag_newXS_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/42_P_miss_y_frag_newXS.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_z_frag_newXS_new = new TCanvas("c_P_miss_z_frag_newXS_new","P_miss_z_frag_newXS_new",1200,800);
   gStyle->SetOptFit(11);
   gStyle->SetOptStat(11);
   h_P_miss_z_frag_newXS_with_accp->SetLineColor(4);
   h_P_miss_z_frag_newXS_with_accp->Draw();
   h_P_miss_z_frag_newXS_with_accp->GetYaxis()->SetRangeUser(0,N_Sim/10.*1.2);
   h_p1zp2z->SetLineColor(1);
   h_p1zp2z->Draw("Same");
   h4->SetLineColor(6);
   h4->Draw("Same");
   ...
   h8->SetNormFactor(N_Sim);
	TLegend *l_P_miss_z_frag_newXS_new = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_z_frag_newXS_new->SetFillColor(0);
	l_P_miss_z_frag_newXS_new->SetBorderSize(1);
	l_P_miss_z_frag_newXS_new->SetTextSize(0.03);
	l_P_miss_z_frag_newXS_new->SetTextFont(32);
   l_P_miss_z_frag_newXS_new->AddEntry(h_P_miss,"Arm-Sim","l");
   l_P_miss_z_frag_newXS_new->AddEntry(h_P_miss_frag_newXS_with_accp,"Frag-Sim","l");
   l_P_miss_z_frag_newXS_new->AddEntry(h8,"Arm-Data","l");
   l_P_miss_z_frag_newXS_new->AddEntry(h4,"Frag-Data","l");
   l_P_miss_z_frag_newXS_new->Draw();
   c_P_miss_z_frag_newXS_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/42_P_miss_z_frag_newXS.pdf",Boost_resolution,TOF_resolution));

   //43
   TCanvas *c_P_miss_frag_newXS_vs_method1_new = new TCanvas("c_P_miss_frag_newXS_vs_method1_new","P_miss_frag_newXS_vs_method1_new",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_frag_newXS_with_accp_vs_method1->SetLineColor(4);
   h_P_miss_frag_newXS_with_accp_vs_method1->Draw("COLZ");
   c_P_miss_frag_newXS_vs_method1_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/43_P_miss_frag_newXS_vs_method1.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_x_frag_newXS_vs_method1_new = new TCanvas("c_P_miss_x_frag_newXS_vs_method1_new","P_miss_x_frag_newXS_vs_method1_new",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_x_frag_newXS_with_accp_vs_method1->SetLineColor(4);
   h_P_miss_x_frag_newXS_with_accp_vs_method1->Draw("COLZ");
   c_P_miss_x_frag_newXS_vs_method1_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/43_P_miss_x_frag_newXS_vs_method1.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_y_frag_newXS_vs_method1_new = new TCanvas("c_P_miss_y_frag_newXS_vs_method1_new","P_miss_y_frag_newXS_vs_method1_new",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_y_frag_newXS_with_accp_vs_method1->SetLineColor(4);
   h_P_miss_y_frag_newXS_with_accp_vs_method1->Draw("COLZ");
   c_P_miss_y_frag_newXS_vs_method1_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/43_P_miss_y_frag_newXS_vs_method1.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_z_frag_newXS_vs_method1_new = new TCanvas("c_P_miss_z_frag_newXS_vs_method1_new","P_miss_z_frag_newXS_vs_method1_new",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_z_frag_newXS_with_accp_vs_method1->SetLineColor(4);
   h_P_miss_z_frag_newXS_with_accp_vs_method1->Draw("COLZ");
   c_P_miss_z_frag_newXS_vs_method1_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/43_P_miss_z_frag_newXS_vs_method1.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_frag_newXS_vs_method1_new1 = new TCanvas("c_P_miss_frag_newXS_vs_method1_new1","P_miss_frag_newXS_vs_method1_new1",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   ...
   h9->Draw("COLZ");
   c_P_miss_frag_newXS_vs_method1_new1->SaveAs(Form("./reco_plot_%3.1f_%2.0f/43_P_miss_frag_newXS_vs_method1_data.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_x_frag_newXS_vs_method1_new1 = new TCanvas("c_P_miss_x_frag_newXS_vs_method1_new1","P_miss_x_frag_newXS_vs_method1_new1",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   ...
   h10->Draw("COLZ");
   c_P_miss_x_frag_newXS_vs_method1_new1->SaveAs(Form("./reco_plot_%3.1f_%2.0f/43_P_miss_x_frag_newXS_vs_method1_data.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_y_frag_newXS_vs_method1_new1 = new TCanvas("c_P_miss_y_frag_newXS_vs_method1_new1","P_miss_y_frag_newXS_vs_method1_new1",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   ...
   h11->Draw("COLZ");
   c_P_miss_y_frag_newXS_vs_method1_new1->SaveAs(Form("./reco_plot_%3.1f_%2.0f/43_P_miss_y_frag_newXS_vs_method1_data.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_z_frag_newXS_vs_method1_new1 = new TCanvas("c_P_miss_z_frag_newXS_vs_method1_new1","P_miss_z_frag_newXS_vs_method1_new1",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   ...
   h12->Draw("COLZ");
   c_P_miss_z_frag_newXS_vs_method1_new1->SaveAs(Form("./reco_plot_%3.1f_%2.0f/43_P_miss_z_frag_newXS_vs_method1_data.pdf",Boost_resolution,TOF_resolution));

   // 44
   TCanvas *c_P_miss_frag_newXS_diff_new = new TCanvas("c_P_miss_frag_newXS_diff_new","P_miss_frag_newXS_diff_new",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_frag_newXS_with_accp_diff->SetLineColor(4);
   h_P_miss_frag_newXS_with_accp_diff->Draw();
   // h_P_miss_frag_newXS_with_accp_diff->GetYaxis()->SetRangeUser(0,N_Sim/10.*1.2);
   h13->SetLineColor(6);
   h13->Draw("Same");
   h13->SetNormFactor(N_Sim);
	TLegend *l_P_miss_frag_newXS_with_accp_diff_new = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_frag_newXS_with_accp_diff_new->SetFillColor(0);
	l_P_miss_frag_newXS_with_accp_diff_new->SetBorderSize(1);
	l_P_miss_frag_newXS_with_accp_diff_new->SetTextSize(0.03);
	l_P_miss_frag_newXS_with_accp_diff_new->SetTextFont(32);
   l_P_miss_frag_newXS_with_accp_diff_new->AddEntry(h_P_miss_frag_newXS_with_accp_diff,"Frag-Arm(Sim)","l");
   l_P_miss_frag_newXS_with_accp_diff_new->AddEntry(h13,"Frag-Arm(Data)","l");
   l_P_miss_frag_newXS_with_accp_diff_new->Draw();
   c_P_miss_frag_newXS_diff_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/44_P_miss_frag_newXS_diff.pdf",Boost_resolution,TOF_resolution));


   TCanvas *c_P_miss_x_frag_newXS_diff_new = new TCanvas("c_P_miss_x_frag_newXS_diff_new","P_miss_x_frag_newXS_diff_new",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_x_frag_newXS_with_accp_diff->SetLineColor(4);
   h_P_miss_x_frag_newXS_with_accp_diff->Draw();
   // h_P_miss_x_frag_newXS_with_accp_diff->GetYaxis()->SetRangeUser(0,N_Sim/10.*1.2);
   h14->SetLineColor(6);
   h14->Draw("Same");
   h14->SetNormFactor(N_Sim);
	TLegend *l_P_miss_x_frag_newXS_with_accp_diff_new = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_x_frag_newXS_with_accp_diff_new->SetFillColor(0);
	l_P_miss_x_frag_newXS_with_accp_diff_new->SetBorderSize(1);
	l_P_miss_x_frag_newXS_with_accp_diff_new->SetTextSize(0.03);
	l_P_miss_x_frag_newXS_with_accp_diff_new->SetTextFont(32);
   l_P_miss_x_frag_newXS_with_accp_diff_new->AddEntry(h_P_miss_x_frag_newXS_with_accp_diff,"Frag-Arm(Sim)","l");
   l_P_miss_x_frag_newXS_with_accp_diff_new->AddEntry(h14,"Frag-Arm(Data)","l");
   l_P_miss_x_frag_newXS_with_accp_diff_new->Draw();
   c_P_miss_x_frag_newXS_diff_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/44_P_miss_x_frag_newXS_diff.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_y_frag_newXS_diff_new = new TCanvas("c_P_miss_y_frag_newXS_diff_new","P_miss_y_frag_newXS_diff_new",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_y_frag_newXS_with_accp_diff->SetLineColor(4);
   h_P_miss_y_frag_newXS_with_accp_diff->Draw();
   // h_P_miss_y_frag_newXS_with_accp_diff->GetYaxis()->SetRangeUser(0,N_Sim/10.*1.2);
   h15->SetLineColor(6);
   h15->Draw("Same");
   h15->SetNormFactor(N_Sim);
	TLegend *l_P_miss_y_frag_newXS_with_accp_diff_new = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_y_frag_newXS_with_accp_diff_new->SetFillColor(0);
	l_P_miss_y_frag_newXS_with_accp_diff_new->SetBorderSize(1);
	l_P_miss_y_frag_newXS_with_accp_diff_new->SetTextSize(0.03);
	l_P_miss_y_frag_newXS_with_accp_diff_new->SetTextFont(32);
   l_P_miss_y_frag_newXS_with_accp_diff_new->AddEntry(h_P_miss_y_frag_newXS_with_accp_diff,"Frag-Arm(Sim)","l");
   l_P_miss_y_frag_newXS_with_accp_diff_new->AddEntry(h15,"Frag-Arm(Data)","l");
   l_P_miss_y_frag_newXS_with_accp_diff_new->Draw();
   c_P_miss_y_frag_newXS_diff_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/44_P_miss_y_frag_newXS_diff.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_P_miss_z_frag_newXS_diff_new = new TCanvas("c_P_miss_z_frag_newXS_diff_new","P_miss_z_frag_newXS_diff_new",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_P_miss_z_frag_newXS_with_accp_diff->SetLineColor(4);
   h_P_miss_z_frag_newXS_with_accp_diff->Draw();
   // h_P_miss_z_frag_newXS_with_accp_diff->GetYaxis()->SetRangeUser(0,N_Sim/10.*1.2);
   h16->SetLineColor(6);
   h16->Draw("Same");
   h16->SetNormFactor(N_Sim);
	TLegend *l_P_miss_z_frag_newXS_with_accp_diff_new = new TLegend(0.65,0.2,0.9,0.4,Form(""));
	l_P_miss_z_frag_newXS_with_accp_diff_new->SetFillColor(0);
	l_P_miss_z_frag_newXS_with_accp_diff_new->SetBorderSize(1);
	l_P_miss_z_frag_newXS_with_accp_diff_new->SetTextSize(0.03);
	l_P_miss_z_frag_newXS_with_accp_diff_new->SetTextFont(32);
   l_P_miss_z_frag_newXS_with_accp_diff_new->AddEntry(h_P_miss_z_frag_newXS_with_accp_diff,"Frag-Arm(Sim)","l");
   l_P_miss_z_frag_newXS_with_accp_diff_new->AddEntry(h16,"Frag-Arm(Data)","l");
   l_P_miss_z_frag_newXS_with_accp_diff_new->Draw();
   c_P_miss_z_frag_newXS_diff_new->SaveAs(Form("./reco_plot_%3.1f_%2.0f/44_P_miss_z_frag_newXS_diff.pdf",Boost_resolution,TOF_resolution));
   ...
   TCanvas *c_Pmiss_diff_ratio_frag_newXS = new TCanvas("c_Pmiss_diff_ratio_frag_newXS","Pmiss_diff_ratio_frag_newXS",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_Pmiss_diff_ratio_frag_newXS->Draw("COLZ");
   c_Pmiss_diff_ratio_frag_newXS->SaveAs(Form("./reco_plot_%3.1f_%2.0f/45_Pmiss_diff_ratio_frag_newXS.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_Pmiss_diff_ratio_frag_newXS1 = new TCanvas("c_Pmiss_diff_ratio_frag_newXS1","Pmiss_diff_ratio_frag_newXS1",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   ...
   h18->Draw("COLZ");
   c_Pmiss_diff_ratio_frag_newXS1->SaveAs(Form("./reco_plot_%3.1f_%2.0f/45_Pmiss_diff_ratio_frag_newXS_data.pdf",Boost_resolution,TOF_resolution));
   ...
   // 46
   TCanvas *c_Pmiss_frag_newXS_theta = new TCanvas("c_Pmiss_frag_newXS_theta","c_Pmiss_frag_newXS_theta",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h_Pmiss_frag_newXS_theta->Draw("COLZ");
   c_Pmiss_frag_newXS_theta->SaveAs(Form("./reco_plot_%3.1f_%2.0f/46_Pmiss_frag_newXS_theta.pdf",Boost_resolution,TOF_resolution));

   TCanvas *c_h_Pmiss_frag_newXS_theta1 = new TCanvas("c_Pmiss_frag_newXS_theta1","c_Pmiss_frag_newXS_theta1",1200,800);
   gStyle->SetOptFit(111);
   gStyle->SetOptStat(1111);
   h20->SetYTitle("Theta");
   ...
   h20->Draw("COLZ");
   c_h_Pmiss_frag_newXS_theta1->SaveAs(Form("./reco_plot_%3.1f_%2.0f/46_Pmiss_frag_newXS_theta_data.pdf",Boost_resolution,TOF_resolution));
