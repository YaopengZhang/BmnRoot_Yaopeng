#define v1p2_50Mio_noInMed_cxx
#include "v1p2_50Mio_noInMed.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void v1p2_50Mio_noInMed::Loop()
{
//   In a ROOT session, you can do:
//      root> .L v1p2_50Mio_noInMed.C
//      root> v1p2_50Mio_noInMed t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   Long64_t nentries = fChain->GetEntries(); // 1057690
   cout<<nentries<<endl;
   ...
   TFile *f = new TFile("./vertex_v1p2_50Mio_noInMed.root","RECREATE"); // "UPDATE"
   ...
   ofstream OUT("Generator_input_v1p2_50Mio_noInMed.txt"); // Generate the input file for FairAsciiGenerator
