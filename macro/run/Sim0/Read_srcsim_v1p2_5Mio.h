...
// found on file: srcsim_v1p2_5Mio.root
//////////////////////////////////////////////////////////

#ifndef Read_srcsim_v1p2_5Mio_h
#define Read_srcsim_v1p2_5Mio_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Read_srcsim_v1p2_5Mio(TTree *tree=0);
   virtual ~Read_srcsim_v1p2_5Mio();
...
#ifdef Read_srcsim_v1p2_5Mio_cxx
Read_srcsim_v1p2_5Mio::Read_srcsim_v1p2_5Mio(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_v1p2_5Mio.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("srcsim_v1p2_5Mio.root");
      }
      ...
      chain->Add("srcsim_v1p2_5Mio.root");
      // chain->Add("srcsim_v1p2_5Mio_1.root");
      // chain->Add("srcsim_v1p2_5Mio_2.root");
      // chain->Add("srcsim_v1p2_5Mio_3.root");
...
Read_srcsim_v1p2_5Mio::~Read_srcsim_v1p2_5Mio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Read_srcsim_v1p2_5Mio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Read_srcsim_v1p2_5Mio::LoadTree(Long64_t entry)
{
...
void Read_srcsim_v1p2_5Mio::Init(TTree *tree)
{
...
Bool_t Read_srcsim_v1p2_5Mio::Notify()
{
...
void Read_srcsim_v1p2_5Mio::Show(Long64_t entry)
{
...
Int_t Read_srcsim_v1p2_5Mio::Cut(Long64_t entry)
{
...
#endif // #ifdef Read_srcsim_v1p2_5Mio_cxx