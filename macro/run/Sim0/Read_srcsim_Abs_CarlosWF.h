...
// found on file: srcsim_Abs_CarlosWF.root
//////////////////////////////////////////////////////////

#ifndef Read_srcsim_Abs_CarlosWF_h
#define Read_srcsim_Abs_CarlosWF_h
...
class Read_srcsim_Abs_CarlosWF {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Read_srcsim_Abs_CarlosWF(TTree *tree=0);
   virtual ~Read_srcsim_Abs_CarlosWF();
...
#ifdef Read_srcsim_Abs_CarlosWF_cxx
Read_srcsim_Abs_CarlosWF::Read_srcsim_Abs_CarlosWF(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_CarlosWF.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("srcsim_Abs_CarlosWF.root");
      }
      // f->GetObject("bmndata",tree);

      // TFile *f1 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_CarlosWF_1.root");
      // if (!f1 || !f1->IsOpen()) {
      //    f1 = new TFile("srcsim_Abs_CarlosWF_1.root");
      // }

      // TFile *f2 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_CarlosWF_2.root");
      // if (!f2 || !f2->IsOpen()) {
      //    f2 = new TFile("srcsim_Abs_CarlosWF_2.root");
      // }

      // TFile *f3 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_CarlosWF_3.root");
      // if (!f3 || !f3->IsOpen()) {
      //    f3 = new TFile("srcsim_Abs_CarlosWF_3.root");
      // }

      // TFile *f4 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_CarlosWF_4.root");
      // if (!f4 || !f4->IsOpen()) {
      //    f4 = new TFile("srcsim_Abs_CarlosWF_4.root");
      // }
      // // f->GetObject("bmndata",tree);

      // TFile *f5 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_CarlosWF_5.root");
      // if (!f5 || !f5->IsOpen()) {
      //    f5 = new TFile("srcsim_Abs_CarlosWF_5.root");
      // }

      // TFile *f6 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_CarlosWF_6.root");
      // if (!f6 || !f6->IsOpen()) {
      //    f6 = new TFile("srcsim_Abs_CarlosWF_6.root");
      // }

      // TFile *f7 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_CarlosWF_7.root");
      // if (!f7 || !f7->IsOpen()) {
      //    f7 = new TFile("srcsim_Abs_CarlosWF_7.root");
      // }
      ...
      chain->Add("srcsim_Abs_CarlosWF.root");
      // chain->Add("srcsim_Abs_CarlosWF_1.root");
      // chain->Add("srcsim_Abs_CarlosWF_2.root");
      // chain->Add("srcsim_Abs_CarlosWF_3.root");
      // chain->Add("srcsim_Abs_CarlosWF_4.root");
      // chain->Add("srcsim_Abs_CarlosWF_5.root");
      // chain->Add("srcsim_Abs_CarlosWF_6.root");
      // chain->Add("srcsim_Abs_CarlosWF_7.root");
...
Read_srcsim_Abs_CarlosWF::~Read_srcsim_Abs_CarlosWF()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Read_srcsim_Abs_CarlosWF::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Read_srcsim_Abs_CarlosWF::LoadTree(Long64_t entry)
{
...
void Read_srcsim_Abs_CarlosWF::Init(TTree *tree)
{
...
Bool_t Read_srcsim_Abs_CarlosWF::Notify()
{
...
void Read_srcsim_Abs_CarlosWF::Show(Long64_t entry)
{
...
Int_t Read_srcsim_Abs_CarlosWF::Cut(Long64_t entry)
{
...
#endif // #ifdef Read_srcsim_Abs_CarlosWF_cxx
