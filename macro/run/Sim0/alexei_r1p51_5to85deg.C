#define alexei_r1p51_5to85deg_cxx
#include "alexei_r1p51_5to85deg.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void alexei_r1p51_5to85deg::Loop()
{
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile *f = new TFile("./vertex_alexei_r1p51_5to85deg.root","RECREATE"); // "UPDATE"
   ...
   ofstream OUT("Generator_input_alexei_r1p51_5to85deg.txt"); // Generate the input file for FairAsciiGenerator
