#define Read_srcsim_Abs_CarlosWF_cxx
#include "Read_srcsim_Abs_CarlosWF.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
Double_t Read_srcsim_Abs_CarlosWF::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_Abs_CarlosWF.C
//      root> Read_srcsim_Abs_CarlosWF t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TChain ch("T");
   ch.Add("EventOutput_01_Abs_CarlosWF_10Mio.root/T");
   ch.Add("EventOutput_02_Abs_CarlosWF_10Mio.root/T");
   ch.Add("EventOutput_03_Abs_CarlosWF_10Mio.root/T");
   ch.Add("EventOutput_04_Abs_CarlosWF_10Mio.root/T");
   ch.Add("EventOutput_05_Abs_CarlosWF_10Mio.root/T");
   ch.Add("EventOutput_06_Abs_CarlosWF_10Mio.root/T");
   ch.Add("EventOutput_07_Abs_CarlosWF_10Mio.root/T");
   ch.Add("EventOutput_08_Abs_CarlosWF_10Mio.root/T");
   ch.Add("EventOutput_09_Abs_CarlosWF_10Mio.root/T");
   ch.Add("EventOutput_10_Abs_CarlosWF_10Mio.root/T");
   ...
   ch_vertex.Add("vertex_Abs_CarlosWF.root");
   // ch_vertex.Add("vertex_Abs_CarlosWF_1.root");
   ...
   TH1F *h_proton_rec_angle_diff = new TH1F("proton_rec_angle_diff","Opening angle between reconstructed proton momentum and generator momentum",100,0.,1);
   h_proton_rec_angle_diff->SetXTitle("Angle Diff [Degree]");
   ...
   TFile *file_output_QE = new TFile("./QE_Simulation_Abs_CarlosWF.root","RECREATE"); // "UPDATE"
   ...
   tree_QE->Branch("TimeOfFlight_TOF400D_left",&TOF_left,"TimeOfFlight_TOF400D_left/D");
   tree_QE->Branch("TimeOfFlight_TOF400D_right",&TOF_right,"TimeOfFlight_TOF400D_right/D");
   ...
   // for (Long64_t jentry=3175428; jentry<4233118;jentry++) {
      ...
      if(Flag_left==1){
         ...
         TVector3 p_rec_left(Px_left,Py_left,Pz_left);
         TVector3 p_gen_left(px_left_initial,py_left_initial,pz_left_initial);
         Double_t proton_rec_angle_diff_left = p_rec_left.Angle(p_gen_left)/3.14159*180;
         h_proton_rec_angle_diff->Fill(proton_rec_angle_diff_left,weight);
      ...
      if(Flag_right==1){
         ...
         TVector3 p_rec_right(Px_right,Py_right,Pz_right);
         TVector3 p_gen_right(px_right_initial,py_right_initial,pz_right_initial);
         Double_t proton_rec_angle_diff_right = p_rec_right.Angle(p_gen_right)/3.14159*180;
         h_proton_rec_angle_diff->Fill(proton_rec_angle_diff_right,weight);
   ...
   TFile *My_output = new TFile("./my_output_Abs_CarlosWF.root", "RECREATE");
   h_proton_rec_angle_diff->Write();
   h_vertex_z->Write();
   h_vertex_x->Write();
   h_vertex_y->Write();
   h_vertex_xy->Write();
   ...
   TFile *My_output_generator = new TFile("./my_output_generator_Abs_CarlosWF.root", "RECREATE");
   h_vertex_z_1->Write();
   h_vertex_x_1->Write();
   h_vertex_y_1->Write();
   h_vertex_xy_1->Write();
