#define alexei_r1p581_cxx
#include "alexei_r1p581.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void alexei_r1p581::Loop()
{
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile *f = new TFile("./vertex_alexei_r1p581.root","RECREATE"); // "UPDATE"
   ...
   ofstream OUT("Generator_input_alexei_r1p581.txt"); // Generate the input file for FairAsciiGenerator
