...
void delta_test(){
    ...
    TFile *f = new TFile("./vertex_delta_test.root","RECREATE"); // "UPDATE"
    ...
    TFile *f_gen = new TFile("./gen_delta_test.root","RECREATE"); // "UPDATE"
    ...
    ofstream OUT("Generator_input_delta_test.txt"); // Generate the input file for FairAsciiGenerator
    ofstream OUT_delta("Delta_events_delta_test.txt"); 
