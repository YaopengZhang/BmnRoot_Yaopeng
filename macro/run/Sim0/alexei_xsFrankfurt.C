#define alexei_xsFrankfurt_cxx
#include "alexei_xsFrankfurt.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void alexei_xsFrankfurt::Loop()
{
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile *f = new TFile("./vertex_alexei_xsFrankfurt.root","RECREATE"); // "UPDATE"
   ...
   ofstream OUT("Generator_input_alexei_xsFrankfurt.txt"); // Generate the input file for FairAsciiGenerator
