...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile *f = new TFile("./vertex_alexei_r0.root","RECREATE"); // "UPDATE"
   ...
   ofstream OUT("Generator_input_alexei_r0.txt"); // Generate the input file for FairAsciiGenerator
