#define Read_srcsim_NoAbs_WF_100Mio_cxx
#include "Read_srcsim_NoAbs_WF_100Mio.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
Double_t Read_srcsim_NoAbs_WF_100Mio::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_NoAbs_WF_100Mio.C
//      root> Read_srcsim_NoAbs_WF_100Mio t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TChain ch("T");
   ch.Add("EventOutput_1_NoAbs_WF_thetaCut_100Mio.root/T");
   ch.Add("EventOutput_2_NoAbs_WF_thetaCut_100Mio.root/T");
   ch.Add("EventOutput_3_NoAbs_WF_thetaCut_100Mio.root/T");
   ch.Add("EventOutput_4_NoAbs_WF_thetaCut_100Mio.root/T");
   ch.Add("EventOutput_5_NoAbs_WF_thetaCut_100Mio.root/T");
   ...
   ch_vertex.Add("vertex_NoAbs_WF_100Mio.root");
   ...
   TFile *file_output_QE = new TFile("./QE_Simulation_NoAbs_WF_100Mio.root","RECREATE"); // "UPDATE"
   ...
   TFile *My_output = new TFile("./my_output_NoAbs_WF_100Mio.root", "RECREATE");
   ...
   TFile *My_output_generator = new TFile("./my_output_generator_NoAbs_WF_100Mio.root", "RECREATE");
   h_vertex_z_1->Write();
   h_vertex_x_1->Write();
   h_vertex_y_1->Write();
   h_vertex_xy_1->Write();
