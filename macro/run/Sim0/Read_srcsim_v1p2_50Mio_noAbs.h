...
// found on file: srcsim_v1p2_50Mio_noAbs.root
//////////////////////////////////////////////////////////

#ifndef Read_srcsim_v1p2_50Mio_noAbs_h
#define Read_srcsim_v1p2_50Mio_noAbs_h
...
class Read_srcsim_v1p2_50Mio_noAbs {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Read_srcsim_v1p2_50Mio_noAbs(TTree *tree=0);
   virtual ~Read_srcsim_v1p2_50Mio_noAbs();
...
#ifdef Read_srcsim_v1p2_50Mio_noAbs_cxx
Read_srcsim_v1p2_50Mio_noAbs::Read_srcsim_v1p2_50Mio_noAbs(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_v1p2_50Mio_noAbs.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("srcsim_v1p2_50Mio_noAbs.root");
      }
      // f->GetObject("bmndata",tree);

      TFile *f1 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_v1p2_50Mio_noAbs_1.root");
      if (!f1 || !f1->IsOpen()) {
         f1 = new TFile("srcsim_v1p2_50Mio_noAbs_1.root");
      }

      TTree *tree0, *tree1, *tree2;
      f->GetObject("bmndata", tree0);
      f1->GetObject("bmndata", tree1);

      TChain* chain = new TChain("bmndata");
      chain->Add("srcsim_v1p2_50Mio_noAbs.root");
      chain->Add("srcsim_v1p2_50Mio_noAbs_1.root");
...
Read_srcsim_v1p2_50Mio_noAbs::~Read_srcsim_v1p2_50Mio_noAbs()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Read_srcsim_v1p2_50Mio_noAbs::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Read_srcsim_v1p2_50Mio_noAbs::LoadTree(Long64_t entry)
{
...
void Read_srcsim_v1p2_50Mio_noAbs::Init(TTree *tree)
{
...
Bool_t Read_srcsim_v1p2_50Mio_noAbs::Notify()
{
...
void Read_srcsim_v1p2_50Mio_noAbs::Show(Long64_t entry)
{
...
Int_t Read_srcsim_v1p2_50Mio_noAbs::Cut(Long64_t entry)
{
...
#endif // #ifdef Read_srcsim_v1p2_50Mio_noAbs_cxx
