#define v1p2_50Mio_noAbs_cxx
#include "v1p2_50Mio_noAbs.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void v1p2_50Mio_noAbs::Loop()
{
//   In a ROOT session, you can do:
//      root> .L v1p2_50Mio_noAbs.C
//      root> v1p2_50Mio_noAbs t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile *f = new TFile("./vertex_v1p2_50Mio_noAbs.root","RECREATE"); // "UPDATE"
   ...
   ofstream OUT("Generator_input_v1p2_50Mio_noAbs.txt"); // Generate the input file for FairAsciiGenerator
