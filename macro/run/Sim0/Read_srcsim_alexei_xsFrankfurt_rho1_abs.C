#define Read_srcsim_alexei_xsFrankfurt_rho1_abs_cxx
#include "Read_srcsim_alexei_xsFrankfurt_rho1_abs.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
Double_t Read_srcsim_alexei_xsFrankfurt_rho1_abs::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_alexei_xsFrankfurt_rho1_abs.C
//      root> Read_srcsim_alexei_xsFrankfurt_rho1_abs t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TChain ch("T");
   ch.Add("gen_alexei_xsFrankfurt_rho1_abs.root");
   ...
   ch_vertex.Add("vertex_alexei_xsFrankfurt_rho1_abs.root");
   ...
   TH1F *h_vertex_z_1 = new TH1F("vertex_z_1","Z vertex position",40,-603,-547);
   ...
   TFile *file_output_QE = new TFile("./QE_Simulation_alexei_xsFrankfurt_rho1_abs.root","RECREATE"); // "UPDATE"
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if(fabs(StsPoint_fPx[0])<1e-5 || fabs(TOF400Point_fPx[0])<1e-5){
         memset(StsPoint_fPx,0,sizeof(StsPoint_fPx));
         memset(StsPoint_fPy,0,sizeof(StsPoint_fPy));
         memset(StsPoint_fPz,0,sizeof(StsPoint_fPz));
   ...
   TFile *My_output = new TFile("./my_output_alexei_xsFrankfurt_rho1_abs.root", "RECREATE");
   h_vertex_z->Write();
   h_p1x->Write();
   h_p1y->Write();
   h_p1z->Write();
   ...
   TFile *My_output_generator = new TFile("./my_output_generator_alexei_xsFrankfurt_rho1_abs.root", "RECREATE");
   h_p1x_1->Write();
   h_p1y_1->Write();
   h_p1z_1->Write();
   h_E1_1->Write();
