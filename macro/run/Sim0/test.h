...
// Mon Oct  2 00:12:31 2023 by ROOT version 6.26/02
// from TChain bmndata/
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("srcsim_1.root");
      }
      ...
      chain->Add("srcsim.root/bmndata");
      chain->Add("srcsim_1.root/bmndata");
      tree = chain;
#endif // SINGLE_TREE
