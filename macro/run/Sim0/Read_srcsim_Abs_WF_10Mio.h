...
// found on file: srcsim_Abs_WF_10Mio.root
//////////////////////////////////////////////////////////

#ifndef Read_srcsim_Abs_WF_10Mio_h
#define Read_srcsim_Abs_WF_10Mio_h
...
class Read_srcsim_Abs_WF_10Mio {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Read_srcsim_Abs_WF_10Mio(TTree *tree=0);
   virtual ~Read_srcsim_Abs_WF_10Mio();
...
#ifdef Read_srcsim_Abs_WF_10Mio_cxx
Read_srcsim_Abs_WF_10Mio::Read_srcsim_Abs_WF_10Mio(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TFile *f3 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_old.root");
      if (!f3 || !f3->IsOpen()) {
         f3 = new TFile("srcsim_Abs_WF_10Mio_old.root");
      }

      TFile *f4 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_old_1.root");
      if (!f4 || !f4->IsOpen()) {
         f4 = new TFile("srcsim_Abs_WF_10Mio_old_1.root");
      }
      // f->GetObject("bmndata",tree);

      TFile *f5 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_old_2.root");
      if (!f5 || !f5->IsOpen()) {
         f5 = new TFile("srcsim_Abs_WF_10Mio_old_2.root");
      }

      TFile *f6 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_old_3.root");
      if (!f6 || !f6->IsOpen()) {
         f6 = new TFile("srcsim_Abs_WF_10Mio_old_3.root");
      }

      // TFile *f7 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_7.root");
      // if (!f7 || !f7->IsOpen()) {
      //    f7 = new TFile("srcsim_Abs_WF_10Mio_7.root");
      // }
      ...
      chain->Add("srcsim_Abs_WF_10Mio_old.root");
      chain->Add("srcsim_Abs_WF_10Mio_old_1.root");
      chain->Add("srcsim_Abs_WF_10Mio_old_2.root");
      chain->Add("srcsim_Abs_WF_10Mio_old_3.root");
      // chain->Add("srcsim_Abs_WF_10Mio_7.root");
...
Read_srcsim_Abs_WF_10Mio::~Read_srcsim_Abs_WF_10Mio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Read_srcsim_Abs_WF_10Mio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Read_srcsim_Abs_WF_10Mio::LoadTree(Long64_t entry)
{
...
void Read_srcsim_Abs_WF_10Mio::Init(TTree *tree)
{
...
Bool_t Read_srcsim_Abs_WF_10Mio::Notify()
{
...
void Read_srcsim_Abs_WF_10Mio::Show(Long64_t entry)
{
...
Int_t Read_srcsim_Abs_WF_10Mio::Cut(Long64_t entry)
{
...
#endif // #ifdef Read_srcsim_Abs_WF_10Mio_cxx
