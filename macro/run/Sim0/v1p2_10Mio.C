#define v1p2_10Mio_cxx
#include "v1p2_10Mio.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void v1p2_10Mio::Loop()
{
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   Long64_t nentries = fChain->GetEntries(); // 1270615
   cout<<nentries<<endl;
   ...
   TFile *f = new TFile("./vertex_v1p2_10Mio.root","RECREATE"); // "UPDATE"
   ...
   ofstream OUT("Generator_input_v1p2_10Mio.txt"); // Generate the input file for FairAsciiGenerator
