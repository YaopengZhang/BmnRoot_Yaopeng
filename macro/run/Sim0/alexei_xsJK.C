#define alexei_xsJK_cxx
#include "alexei_xsJK.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void alexei_xsJK::Loop()
{
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile *f = new TFile("./vertex_alexei_xsJK.root","RECREATE"); // "UPDATE"
   ...
   ofstream OUT("Generator_input_alexei_xsJK.txt"); // Generate the input file for FairAsciiGenerator
