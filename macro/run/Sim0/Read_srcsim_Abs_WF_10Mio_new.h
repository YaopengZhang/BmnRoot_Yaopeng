...
// found on file: srcsim_Abs_WF_10Mio_new.root
//////////////////////////////////////////////////////////

#ifndef Read_srcsim_Abs_WF_10Mio_new_h
#define Read_srcsim_Abs_WF_10Mio_new_h
...
class Read_srcsim_Abs_WF_10Mio_new {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Read_srcsim_Abs_WF_10Mio_new(TTree *tree=0);
   virtual ~Read_srcsim_Abs_WF_10Mio_new();
...
#ifdef Read_srcsim_Abs_WF_10Mio_new_cxx
Read_srcsim_Abs_WF_10Mio_new::Read_srcsim_Abs_WF_10Mio_new(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio.root");
      // if (!f || !f->IsOpen()) {
      //    f = new TFile("srcsim_Abs_WF_10Mio.root");
      // }
      // // f->GetObject("bmndata",tree);

      // TFile *f1 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_1.root");
      // if (!f1 || !f1->IsOpen()) {
      //    f1 = new TFile("srcsim_Abs_WF_10Mio_1.root");
      // }

      // TFile *f2 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_2.root");
      // if (!f2 || !f2->IsOpen()) {
      //    f2 = new TFile("srcsim_Abs_WF_10Mio_2.root");
      // }

      // TFile *f3 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_thetaCut.root");
      // if (!f3 || !f3->IsOpen()) {
      //    f3 = new TFile("srcsim_Abs_WF_10Mio_thetaCut.root");
      // }


      // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_new.root");
      // if (!f || !f->IsOpen()) {
      //    f = new TFile("srcsim_Abs_WF_10Mio_new.root");
      // }
      // // f->GetObject("bmndata",tree);

      // TFile *f1 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_new_1.root");
      // if (!f1 || !f1->IsOpen()) {
      //    f1 = new TFile("srcsim_Abs_WF_10Mio_new_1.root");
      // }

      // TFile *f2 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_new_2.root");
      // if (!f2 || !f2->IsOpen()) {
      //    f2 = new TFile("srcsim_Abs_WF_10Mio_new_2.root");
      // }

      // TFile *f3 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_thetaCut_new.root");
      // if (!f3 || !f3->IsOpen()) {
      //    f3 = new TFile("srcsim_Abs_WF_10Mio_thetaCut_new.root");
      // }


      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_latest.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("srcsim_Abs_WF_10Mio_latest.root");
      }
      // f->GetObject("bmndata",tree);

      TFile *f1 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_latest_1.root");
      if (!f1 || !f1->IsOpen()) {
         f1 = new TFile("srcsim_Abs_WF_10Mio_latest_1.root");
      }

      TFile *f2 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_latest_2.root");
      if (!f2 || !f2->IsOpen()) {
         f2 = new TFile("srcsim_Abs_WF_10Mio_latest_2.root");
      }

      TFile *f3 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_latest_3.root");
      if (!f3 || !f3->IsOpen()) {
         f3 = new TFile("srcsim_Abs_WF_10Mio_latest_3.root");
      }


      // TFile *f4 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_new_4.root");
      // if (!f4 || !f4->IsOpen()) {
      //    f4 = new TFile("srcsim_Abs_WF_10Mio_new_4.root");
      // }
      // // f->GetObject("bmndata",tree);

      // TFile *f5 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_new_5.root");
      // if (!f5 || !f5->IsOpen()) {
      //    f5 = new TFile("srcsim_Abs_WF_10Mio_new_5.root");
      // }

      // TFile *f6 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_new_6.root");
      // if (!f6 || !f6->IsOpen()) {
      //    f6 = new TFile("srcsim_Abs_WF_10Mio_new_6.root");
      // }

      // TFile *f7 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_new_7.root");
      // if (!f7 || !f7->IsOpen()) {
      //    f7 = new TFile("srcsim_Abs_WF_10Mio_new_7.root");
      // }
      ...
      chain->Add("srcsim_Abs_WF_10Mio.root");
      chain->Add("srcsim_Abs_WF_10Mio_1.root");
      chain->Add("srcsim_Abs_WF_10Mio_2.root");
      // chain->Add("srcsim_Abs_WF_10Mio_thetaCut.root");

      // chain->Add("srcsim_Abs_WF_10Mio_new.root");
      // chain->Add("srcsim_Abs_WF_10Mio_new_1.root");
      // chain->Add("srcsim_Abs_WF_10Mio_new_2.root");
      // chain->Add("srcsim_Abs_WF_10Mio_thetaCut_new.root");

      // TChain* chain = new TChain("bmndata");
      // chain->Add("srcsim_Abs_WF_10Mio_latest.root");
      // chain->Add("srcsim_Abs_WF_10Mio_latest_1.root");
      // chain->Add("srcsim_Abs_WF_10Mio_latest_2.root");
      // chain->Add("srcsim_Abs_WF_10Mio_latest_3.root");

      // chain->Add("srcsim_Abs_WF_10Mio_new_3.root");
      // chain->Add("srcsim_Abs_WF_10Mio_new_4.root");
      // chain->Add("srcsim_Abs_WF_10Mio_new_5.root");
      // chain->Add("srcsim_Abs_WF_10Mio_new_6.root");
      // chain->Add("srcsim_Abs_WF_10Mio_new_7.root");
...
Read_srcsim_Abs_WF_10Mio_new::~Read_srcsim_Abs_WF_10Mio_new()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Read_srcsim_Abs_WF_10Mio_new::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Read_srcsim_Abs_WF_10Mio_new::LoadTree(Long64_t entry)
{
...
void Read_srcsim_Abs_WF_10Mio_new::Init(TTree *tree)
{
...
Bool_t Read_srcsim_Abs_WF_10Mio_new::Notify()
{
...
void Read_srcsim_Abs_WF_10Mio_new::Show(Long64_t entry)
{
...
Int_t Read_srcsim_Abs_WF_10Mio_new::Cut(Long64_t entry)
{
...
#endif // #ifdef Read_srcsim_Abs_WF_10Mio_new_cxx
