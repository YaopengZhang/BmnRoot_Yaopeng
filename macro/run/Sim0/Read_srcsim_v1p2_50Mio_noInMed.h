...
// found on file: srcsim_v1p2_50Mio_noInMed.root
//////////////////////////////////////////////////////////

#ifndef Read_srcsim_v1p2_50Mio_noInMed_h
#define Read_srcsim_v1p2_50Mio_noInMed_h
...
class Read_srcsim_v1p2_50Mio_noInMed {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Read_srcsim_v1p2_50Mio_noInMed(TTree *tree=0);
   virtual ~Read_srcsim_v1p2_50Mio_noInMed();
...
#ifdef Read_srcsim_v1p2_50Mio_noInMed_cxx
Read_srcsim_v1p2_50Mio_noInMed::Read_srcsim_v1p2_50Mio_noInMed(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_v1p2_50Mio_noInMed.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("srcsim_v1p2_50Mio_noInMed.root");
      }
      // f->GetObject("bmndata",tree);
      // TFile *f2 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_v1p2_50Mio_noInMed_1.root");
      // if (!f2 || !f2->IsOpen()) {
      //    f2 = new TFile("srcsim_v1p2_50Mio_noInMed_1.root");
      // }

      // TFile *f3 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_v1p2_50Mio_noInMed_2.root");
      // if (!f3 || !f3->IsOpen()) {
      //    f3 = new TFile("srcsim_v1p2_50Mio_noInMed_2.root");
      // }

      // TFile *f4 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_v1p2_50Mio_noInMed_3.root");
      // if (!f4 || !f4->IsOpen()) {
      //    f4 = new TFile("srcsim_v1p2_50Mio_noInMed_3.root");
      // }
      ...
      chain->Add("srcsim_v1p2_50Mio_noInMed.root");
      // chain->Add("srcsim_v1p2_50Mio_noInMed_1.root");
      // chain->Add("srcsim_v1p2_50Mio_noInMed_2.root");
      // chain->Add("srcsim_v1p2_50Mio_noInMed_3.root");
...
Read_srcsim_v1p2_50Mio_noInMed::~Read_srcsim_v1p2_50Mio_noInMed()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Read_srcsim_v1p2_50Mio_noInMed::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Read_srcsim_v1p2_50Mio_noInMed::LoadTree(Long64_t entry)
{
...
void Read_srcsim_v1p2_50Mio_noInMed::Init(TTree *tree)
{
...
Bool_t Read_srcsim_v1p2_50Mio_noInMed::Notify()
{
...
void Read_srcsim_v1p2_50Mio_noInMed::Show(Long64_t entry)
{
...
Int_t Read_srcsim_v1p2_50Mio_noInMed::Cut(Long64_t entry)
{
...
#endif // #ifdef Read_srcsim_v1p2_50Mio_noInMed_cxx
