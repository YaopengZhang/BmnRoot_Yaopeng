#define Read_srcsim_Abs_WF_10Mio_thetaCut_cxx
#include "Read_srcsim_Abs_WF_10Mio_thetaCut.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
const double qe_theta_sigmas = 2;
const double qe_mmiss2_sigmas = 1.1;
const double ThetaMean = 6.63650e+01;
const double ThetaSigma = qe_theta_sigmas * 2.13496e+00;
const double Mmiss2Mean = 8.79017e-01;
const double Mmiss2Sigma = qe_mmiss2_sigmas * 2.08649e-01;

// qe_mmiss_sigmas = 1.1
// qe_sigmas = 2.0
// mMissMean = 8.79017e-01
// mMissSigma = qe_mmiss_sigmas * 2.08649e-01
// thetaMean = 6.63650e+01
// thetaSigma = qe_sigmas * 2.13496e+00
...
Double_t Read_srcsim_Abs_WF_10Mio_thetaCut::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_Abs_WF_10Mio_thetaCut.C
//      root> Read_srcsim_Abs_WF_10Mio_thetaCut t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TChain ch("T");
   // ch.Add("EventOutput_1_Abs_WF_thetaCut_10Mio.root/T");
   ...
   // ch_vertex.Add("vertex_Abs_WF_10Mio_thetaCut_old.root");

   // ofstream OUT("EvtNo_QE_thetaCut_accp_new.txt");
   // ofstream OUT("EvtNo_QE_thetaCut_accp_old.txt");
   ...
   TFile *file_output_QE = new TFile("./QE_Simulation_Abs_WF_10Mio_thetaCut.root","RECREATE"); // "UPDATE"
   ...
   TFile *My_output = new TFile("./my_output_Abs_WF_10Mio_thetaCut.root", "RECREATE");
   h_vertex_z->Write();
   h_vertex_x->Write();
   h_vertex_y->Write();
   h_vertex_xy->Write();
   ...
   TFile *My_output_generator = new TFile("./my_output_generator_Abs_WF_10Mio_thetaCut.root", "RECREATE");
   h_vertex_z_1->Write();
   h_vertex_x_1->Write();
   h_vertex_y_1->Write();
   h_vertex_xy_1->Write();
