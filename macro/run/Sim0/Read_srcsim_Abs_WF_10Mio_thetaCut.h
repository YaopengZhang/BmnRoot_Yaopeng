...
// found on file: srcsim_Abs_WF_10Mio_thetaCut.root
//////////////////////////////////////////////////////////

#ifndef Read_srcsim_Abs_WF_10Mio_thetaCut_h
#define Read_srcsim_Abs_WF_10Mio_thetaCut_h
...
class Read_srcsim_Abs_WF_10Mio_thetaCut {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Read_srcsim_Abs_WF_10Mio_thetaCut(TTree *tree=0);
   virtual ~Read_srcsim_Abs_WF_10Mio_thetaCut();
...
#ifdef Read_srcsim_Abs_WF_10Mio_thetaCut_cxx
Read_srcsim_Abs_WF_10Mio_thetaCut::Read_srcsim_Abs_WF_10Mio_thetaCut(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_thetaCut.root");
      // if (!f || !f->IsOpen()) {
      //    f = new TFile("srcsim_Abs_WF_10Mio_thetaCut.root");
      // }
      // f->GetObject("bmndata",tree);

      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_thetaCut_new.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("srcsim_Abs_WF_10Mio_thetaCut_new.root");
      }

      // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_Abs_WF_10Mio_thetaCut_old.root");
      // if (!f || !f->IsOpen()) {
      //    f = new TFile("srcsim_Abs_WF_10Mio_thetaCut_old.root");
      // }
      ...
      // chain->Add("srcsim_Abs_WF_10Mio_thetaCut_old.root");
      // chain->Add("srcsim_Abs_WF_10Mio_thetaCut.root");
      // chain->Add("srcsim_Abs_WF_10Mio_thetaCut_1.root");
      // chain->Add("srcsim_Abs_WF_10Mio_thetaCut_2.root");
      // chain->Add("srcsim_Abs_WF_10Mio_thetaCut_3.root");
      // chain->Add("srcsim_Abs_WF_10Mio_thetaCut_4.root");
      // chain->Add("srcsim_Abs_WF_10Mio_thetaCut_5.root");
      // chain->Add("srcsim_Abs_WF_10Mio_thetaCut_6.root");
      // chain->Add("srcsim_Abs_WF_10Mio_thetaCut_7.root");
...
Read_srcsim_Abs_WF_10Mio_thetaCut::~Read_srcsim_Abs_WF_10Mio_thetaCut()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Read_srcsim_Abs_WF_10Mio_thetaCut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Read_srcsim_Abs_WF_10Mio_thetaCut::LoadTree(Long64_t entry)
{
...
void Read_srcsim_Abs_WF_10Mio_thetaCut::Init(TTree *tree)
{
...
Bool_t Read_srcsim_Abs_WF_10Mio_thetaCut::Notify()
{
...
void Read_srcsim_Abs_WF_10Mio_thetaCut::Show(Long64_t entry)
{
...
Int_t Read_srcsim_Abs_WF_10Mio_thetaCut::Cut(Long64_t entry)
{
...
#endif // #ifdef Read_srcsim_Abs_WF_10Mio_thetaCut_cxx
