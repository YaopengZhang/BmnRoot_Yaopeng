#define Read_srcsim_delta_test_cxx
#include "Read_srcsim_delta_test.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
//    TVector3 vec2(0, 1, 0);
//    cout<<If_delta(4, vec1, vec2, "Delta_events_delta_test.txt")<<endl;
// }

Double_t Read_srcsim_delta_test::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_delta_test.C
//      root> Read_srcsim_delta_test t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   ch_vertex.Add("vertex_delta_test.root");
   ...
   TFile *file_output_QE = new TFile("./QE_Simulation_delta_test.root","RECREATE"); // "UPDATE"
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if(Flag_left==1&&Flag_right==1){
         ...
         else if(If_delta(jentry, vec1, vec2, "Delta_events_delta_test.txt")==1){
            NEvents_from_delta++;
            NonQE_Flag = 1;
         }
   ...
   TFile *My_output = new TFile("./my_output_delta_test.root", "RECREATE");
   h_vertex_z->Write();
   ...
   TFile *My_output_generator = new TFile("./my_output_generator_delta_test.root", "RECREATE");
   h_p1x_1->Write();
   h_p1y_1->Write();
   h_p1z_1->Write();
   h_E1_1->Write();
