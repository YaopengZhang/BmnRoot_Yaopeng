#define Read_srcsim_alexei_cxx
#include "Read_srcsim_alexei.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
Double_t Read_srcsim_alexei::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_alexei.C
//      root> Read_srcsim_alexei t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   ch_vertex.Add("vertex_alexei.root");
   ...
   TFile *file_output_QE = new TFile("./QE_Simulation_alexei.root","RECREATE"); // "UPDATE"
   ...
   TFile *My_output = new TFile("./my_output_alexei.root", "RECREATE");
   h_vertex_z->Write();
   h_p1x->Write();
   h_p1y->Write();
   h_p1z->Write();
   ...
   TFile *My_output_generator = new TFile("./my_output_generator_alexei.root", "RECREATE");
   h_p1x_1->Write();
   h_p1y_1->Write();
   h_p1z_1->Write();
   h_E1_1->Write();
