#define Read_srcsim_src_cxx
#include "Read_srcsim_src.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
Double_t Read_srcsim_src::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_src.C
//      root> Read_srcsim_src t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TChain ch("genT");
   ch.Add("yaopeng_gcf_10M_2p892.root");
   ...
   ch.SetBranchAddress("pAm2",pAm2);

   TChain ch_vertex("vertex");
   ch_vertex.Add("vertex_SRC.root");
   ...
   TH1F *h_p1y = new TH1F("p1y","P1_{ y} in lab system",100,-2,2);
   TH1F *h_p1y_1 = new TH1F("p1y_1","P1_{ y} in lab system",100,-2,2);
   ...
   TH1F *h_p1z = new TH1F("p1z","P1_{ z} in lab reference system",100,0,5);
   TH1F *h_p1z_1 = new TH1F("p1z_1","P1_{ z} in lab reference system",100,0,5);
   ...
   TH1F *h_E1 = new TH1F("P1","P1 in lab system",100,0.5,4.5);
   TH1F *h_E1_1 = new TH1F("P1_1","P1 in lab system",100,0.5,4.5);
   ...
   TH1F *h_p2x = new TH1F("p2x","P2_{ x} in lab system",200,-3,1);
   TH1F *h_p2x_1 = new TH1F("p2x_1","P2_{ x} in lab system",200,-3,1);
   ...
   TH1F *h_p2y = new TH1F("p2y","P2_{ y} in lab system",100,-2,2);
   TH1F *h_p2y_1 = new TH1F("p2y_1","P2_{ y} in lab system",100,-2,2);
   ...
   TH1F *h_p2z = new TH1F("p2z","P2_{ z} in lab system",100,0,5);
   TH1F *h_p2z_1 = new TH1F("p2z_1","P2_{ z} in lab system",100,0,5);
   ...
   TH1F* h_pbx_1 = new TH1F("h_pbx_1","^{11}B momentum distribution in ^{12}C reference system",100,-0.5,0.5);
   TH1F* h_pbx_2 = new TH1F("h_pbx_2","^{11}B momentum distribution in ^{12}C reference system",100,-0.5,0.5);
   TH1F* h_pbx = new TH1F("h_pbx","^{11}B momentum distribution in ^{12}C reference system",100,-0.5,0.5);
   ...
   TH1F* h_pby_1 = new TH1F("h_pby_1","^{11}B momentum distribution in ^{12}C reference system",100,-0.5,0.5);
   TH1F* h_pby_2 = new TH1F("h_pby_2","^{11}B momentum distribution in ^{12}C reference system",100,-0.5,0.5);
   TH1F* h_pby = new TH1F("h_pby","^{11}B momentum distribution in ^{12}C reference system",100,-0.5,0.5);
   ...
   TH1F* h_pbz_1 = new TH1F("h_pbz_1","^{11}B momentum distribution in ^{12}C reference system",100,-0.5,0.5);
   TH1F* h_pbz_2 = new TH1F("h_pbz_2","^{11}B momentum distribution in ^{12}C reference system",100,-0.5,0.5);
   TH1F* h_pbz = new TH1F("h_pbz","^{11}B momentum distribution in ^{12}C reference system",100,-0.5,0.5);
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      // double PB_resolution = 0.0;
      PBX = gRandom->Gaus(PBx,PBx*PB_resolution/1000.);
      PBY = gRandom->Gaus(PBy,PBy*PB_resolution/1000.);
      PBZ = gRandom->Gaus(PBz,PBz*PB_resolution/1000.);
      ...
      if(Flag_left==1){
         ...
         // TOF_left = gRandom->Gaus(TOF_left,0./1000.);   //ns
      ...
      if(Flag_right==1){
         ...
         // TOF_right = gRandom->Gaus(TOF_right,0./1000.);   //ns
      ...
      if(Flag_left==1&&Flag_right==1){
         ...
         double angle_pmiss_pfrag = Pmiss.Angle(Pfrag);
   ...
   TFile *My_output = new TFile("./my_output_src.root", "RECREATE");
   h_opening_theta->Write();
   h_opening_phi->Write();
   h_M_miss->Write();
   h_M_miss_square->Write();
   h_Angle_Pmiss_Pn_cos->Write();
   h_Angle_Pfrag_Prel_cos->Write();
   h_Mmiss_excl->Write();
   h_pb->Write();
   h_pbx->Write();
   h_pby->Write();
