#define Read_srcsim_alexei_r1p51_5to85deg_cxx
#include "Read_srcsim_alexei_r1p51_5to85deg.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
Double_t Read_srcsim_alexei_r1p51_5to85deg::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_alexei_r1p51_5to85deg.C
//      root> Read_srcsim_alexei_r1p51_5to85deg t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TChain ch("T");
   ch.Add("gen_alexei_r1p51_5to85deg.root");
   ...
   ch_vertex.Add("vertex_alexei_r1p51_5to85deg.root");
   ...
   TFile *file_output_QE = new TFile("./QE_Simulation_alexei_r1p51_5to85deg.root","RECREATE"); // "UPDATE"
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      PBX = gRandom->Gaus(PBx,PBx*PB_resolution);
      PBY = gRandom->Gaus(PBy,PBy*PB_resolution);
