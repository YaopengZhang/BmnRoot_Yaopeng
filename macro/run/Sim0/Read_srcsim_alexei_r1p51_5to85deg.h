...
// found on file: srcsim_alexei_r1p51_5to85deg.root
//////////////////////////////////////////////////////////

#ifndef Read_srcsim_alexei_r1p51_5to85deg_h
#define Read_srcsim_alexei_r1p51_5to85deg_h
...
class Read_srcsim_alexei_r1p51_5to85deg {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Read_srcsim_alexei_r1p51_5to85deg(TTree *tree=0);
   virtual ~Read_srcsim_alexei_r1p51_5to85deg();
...
#ifdef Read_srcsim_alexei_r1p51_5to85deg_cxx
Read_srcsim_alexei_r1p51_5to85deg::Read_srcsim_alexei_r1p51_5to85deg(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_alexei_r1p51_5to85deg.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("srcsim_alexei_r1p51_5to85deg.root");
      }
      // f->GetObject("bmndata",tree);
      // TFile *f2 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_alexei_r1p51_5to85deg_1.root");
      // if (!f2 || !f2->IsOpen()) {
      //    f2 = new TFile("srcsim_alexei_r1p51_5to85deg_1.root");
      // }

      // TFile *f3 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_alexei_r1p51_5to85deg_2.root");
      // if (!f3 || !f3->IsOpen()) {
      //    f3 = new TFile("srcsim_alexei_r1p51_5to85deg_2.root");
      // }

      // TFile *f4 = (TFile*)gROOT->GetListOfFiles()->FindObject("srcsim_alexei_r1p51_5to85deg_3.root");
      // if (!f4 || !f4->IsOpen()) {
      //    f4 = new TFile("srcsim_alexei_r1p51_5to85deg_3.root");
      // }
      ...
      chain->Add("srcsim_alexei_r1p51_5to85deg.root");
      // chain->Add("srcsim_alexei_r1p51_5to85deg_1.root");
      // chain->Add("srcsim_alexei_r1p51_5to85deg_2.root");
      // chain->Add("srcsim_alexei_r1p51_5to85deg_3.root");
...
Read_srcsim_alexei_r1p51_5to85deg::~Read_srcsim_alexei_r1p51_5to85deg()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Read_srcsim_alexei_r1p51_5to85deg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Read_srcsim_alexei_r1p51_5to85deg::LoadTree(Long64_t entry)
{
...
void Read_srcsim_alexei_r1p51_5to85deg::Init(TTree *tree)
{
...
Bool_t Read_srcsim_alexei_r1p51_5to85deg::Notify()
{
...
void Read_srcsim_alexei_r1p51_5to85deg::Show(Long64_t entry)
{
...
Int_t Read_srcsim_alexei_r1p51_5to85deg::Cut(Long64_t entry)
{
...
#endif // #ifdef Read_srcsim_alexei_r1p51_5to85deg_cxx
