#define Read_srcsim_delta_test_frag_cxx
#include "Read_srcsim_delta_test_frag.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
//    TVector3 vec2(0, 1, 0);
//    cout<<If_delta(4, vec1, vec2, "Delta_events_delta_test_frag.txt")<<endl;
// }

Double_t Read_srcsim_delta_test_frag::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_delta_test_frag.C
//      root> Read_srcsim_delta_test_frag t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TChain ch("T");
   ch.Add("gen_delta_test_frag.root");
   ...
   ch_vertex.Add("vertex_delta_test_frag.root");
   ...
   std::ifstream file("Delta_events_delta_test_frag_11B.txt");
   if (!file.is_open()) {
      std::cerr << "Can't open the input file!" << std::endl;
      return -1;
   }
   ...
   TH2F *h_opening_theta_Emiss = new TH2F("opening_theta_Emiss","Lab-frame #theta opening angle vs. Emiss",83,-1,1.5,60,50,80);
   ...
   TFile *file_output_QE = new TFile("./QE_Simulation_delta_test_frag.root","RECREATE"); // "UPDATE"
   ...
   // for (Long64_t jentry=0; jentry<100;jentry++) {
      ...
      h_M_miss_square_frag->Fill(M2_frag);
      h_P_miss_frag->Fill(Pmiss_frag);
      h_P_miss_x_frag->Fill(Pmiss_x_frag);
      h_P_miss_y_frag->Fill(Pmiss_y_frag);
      h_P_miss_z_frag->Fill(Pmiss_z_frag);
      ...
      for(int i=0;i<kMaxbmnroot_0_TOF1_TOF400Point;i++){
         ...
         if(TOF400Point_fTrackID[i]==CSCPoint_fTrackID[i]){
            ...
            if(CSCPoint_fPdgId[i]!=2212) delta_pion_flag = 1;
      ...
      if(Flag_left==1&&Flag_right==1){
         ...
         // h_M_miss_square_frag_with_accp->Fill(M2_frag);
         // h_P_miss_frag_with_accp->Fill(Pmiss_frag);
         // h_P_miss_x_frag_with_accp->Fill(Pmiss_x_frag);
         // h_P_miss_y_frag_with_accp->Fill(Pmiss_y_frag);
         // h_P_miss_z_frag_with_accp->Fill(Pmiss_z_frag);
      ...
      if(Flag_left==1&&Flag_right==1){
         ...
         else if(If_delta(jentry, vec1, vec2, "Delta_events_delta_test_frag.txt")==1){
            NEvents_from_delta++;
            NonQE_Flag = 1;
         }
         ...
         h_M_miss_square_frag_with_accp_diff->Fill(M2_frag-M_miss);
         h_P_miss_frag_with_accp_diff->Fill(Pmiss_frag-P_miss);
         h_P_miss_x_frag_with_accp_diff->Fill(Pmiss_x_frag-P_miss_x);
         h_P_miss_y_frag_with_accp_diff->Fill(Pmiss_y_frag-P_miss_y);
         h_P_miss_z_frag_with_accp_diff->Fill(Pmiss_z_frag-P_miss_z);

         h_Pmiss_diff_ratio->Fill((Pmiss_frag-P_miss)/Pmiss_frag*100.);
         h_Pmiss_diff_ratio_frag->Fill(Pmiss_frag,(Pmiss_frag-P_miss)/Pmiss_frag*100.);
         h_Pmiss_diff_ratio_arm->Fill(P_miss,(Pmiss_frag-P_miss)/Pmiss_frag*100.);
         h_Pmiss_frag_theta->Fill(angle_deg,Pmiss_frag);
         h_Pmiss_arm_theta->Fill(angle_deg,P_miss);

         h_M_miss_square_frag_with_accp_vs_method1->Fill(M2_frag,M_miss);
         // h_P_miss_frag_with_accp_vs_method1->Fill(Pmiss_frag,P_miss);
         // h_P_miss_x_frag_with_accp_vs_method1->Fill(Pmiss_x_frag,P_miss_x);
         // h_P_miss_y_frag_with_accp_vs_method1->Fill(Pmiss_y_frag,P_miss_y);
         // h_P_miss_z_frag_with_accp_vs_method1->Fill(Pmiss_z_frag,P_miss_z);
         h_P_miss_frag_with_accp_vs_method1->Fill(P_miss,Pmiss_frag);
         h_P_miss_x_frag_with_accp_vs_method1->Fill(P_miss_x,Pmiss_x_frag);
         h_P_miss_y_frag_with_accp_vs_method1->Fill(P_miss_y,Pmiss_y_frag);
         h_P_miss_z_frag_with_accp_vs_method1->Fill(P_miss_z,Pmiss_z_frag);
         //--Comparation between reconstruction form fragments and reconstruction form protons
   ...
   TFile *My_output = new TFile("./my_output_delta_test_frag.root", "RECREATE");
   h_vertex_z->Write();
   ...
   TFile *My_output_generator = new TFile("./my_output_generator_delta_test_frag.root", "RECREATE");
   h_p1x_1->Write();
   h_p1y_1->Write();
   h_p1z_1->Write();
   h_E1_1->Write();
   ...
   h_M_miss_square_frag_with_accp->Draw();
   ...
   if(Experiment_Flag==1){
      l_M_miss_square_frag->AddEntry(h_M_miss_square_exp,"Experiment July 30","l");
   }
   l_M_miss_square_frag->Draw();
   ...
   if(Experiment_Flag==1){
      l_P_miss_frag->AddEntry(h_P_miss_exp,"Experiment July 30","l");
   }
   l_P_miss_frag->Draw();
   ...
   h_P_miss_x_frag_with_accp->Draw();
   ...
   if(Experiment_Flag==1){
      l_P_miss_x_frag->AddEntry(h_P_miss_x_exp,"Experiment July 30","l");
   }
   l_P_miss_x_frag->Draw();
   ...
   h_P_miss_y_frag_with_accp->Draw();
   ...
   if(Experiment_Flag==1){
      l_P_miss_y_frag->AddEntry(h_P_miss_y_exp,"Experiment July 30","l");
   }
   l_P_miss_y_frag->Draw();
   ...
   h_P_miss_z_frag_with_accp->Draw();
   ...
   if(Experiment_Flag==1){
      l_P_miss_z_frag->AddEntry(h_P_miss_z_exp,"Experiment July 30","l");
   }
   l_P_miss_z_frag->Draw();
   ...
   h_M_miss_square_frag_with_accp_diff->Draw();
   ...
   h_P_miss_frag_with_accp_diff->Draw();
   ...
   h_P_miss_x_frag_with_accp_diff->Draw();
   ...
   h_P_miss_y_frag_with_accp_diff->Draw();
   ...
   h_P_miss_z_frag_with_accp_diff->Draw();
   ...
   l_P_miss_frag_with_accp_diff_new->Draw();
   ...
   l_P_miss_x_frag_with_accp_diff_new->Draw();
   ...
   l_P_miss_y_frag_with_accp_diff_new->Draw();
   ...
   l_P_miss_z_frag_with_accp_diff_new->Draw();
