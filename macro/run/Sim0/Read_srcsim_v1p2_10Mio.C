#define Read_srcsim_v1p2_10Mio_cxx
#include "Read_srcsim_v1p2_10Mio.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
Double_t Read_srcsim_v1p2_10Mio::Loop(Double_t Boost_resolution, Double_t TOF_resolution)
{
//   In a ROOT session, you can do:
//      root> .L Read_srcsim_v1p2_10Mio.C
//      root> Read_srcsim_v1p2_10Mio t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TChain ch("T");
   ch.Add("gen_v1p2_10Mio_job1.root/T");
   ch.Add("gen_v1p2_10Mio_job2.root/T");
   ch.Add("gen_v1p2_10Mio_job3.root/T");
   ch.Add("gen_v1p2_10Mio_job4.root/T");
   ch.Add("gen_v1p2_10Mio_job5.root/T");
   ch.Add("gen_v1p2_10Mio_job6.root/T");
   ...
   ch_vertex.Add("vertex_v1p2_10Mio.root");
   ...
   TH1F* h_Mandelstam_u_t_min_1 = new TH1F("h_Mandelstam_u_t_min_1","Mandelstam variable Min{|u|, |t|}",100,0,7);
   TH1F* h_Mandelstam_u_t_min = new TH1F("h_Mandelstam_u_t_min","Mandelstam variable Min{|u|, |t|}",100,0,7);
   ...
   TH1F *h_p1x = new TH1F("p1x","P1_{ x} in lab  system",150,0.5,1.5);
   TH1F *h_p1x_1 = new TH1F("p1x_1","P1_{ x} in lab  system",150,0.5,1.5);
   ...
   TH1F *h_p1y = new TH1F("p1y","P1_{ y} in lab system",150,-1,1);
   TH1F *h_p1y_1 = new TH1F("p1y_1","P1_{ y} in lab system",150,-1,1);
   ...
   TH1F *h_p1z = new TH1F("p1z","P1_{ z} in lab reference system",150,0.5,4);
   TH1F *h_p1z_1 = new TH1F("p1z_1","P1_{ z} in lab reference system",150,0.5,4);
   ...
   TH1F *h_E1 = new TH1F("P1","P1 in lab system",150,1,4);
   TH1F *h_E1_1 = new TH1F("P1_1","P1 in lab system",150,1,4);
   ...
   TH1F *h_p2x = new TH1F("p2x","P2_{ x} in lab system",150,-1.5,-0.5);
   TH1F *h_p2x_1 = new TH1F("p2x_1","P2_{ x} in lab system",150,-1.5,-0.5);
   ...
   TH1F *h_p2y = new TH1F("p2y","P2_{ y} in lab system",150,-1,1);
   TH1F *h_p2y_1 = new TH1F("p2y_1","P2_{ y} in lab system",150,-1,1);
   ...
   TH1F *h_p2z = new TH1F("p2z","P2_{ z} in lab system",150,0.5,4);
   TH1F *h_p2z_1 = new TH1F("p2z_1","P2_{ z} in lab system",150,0.5,4);
   ...
   TH1F *h_E2 = new TH1F("P2","P2 in lab system",150,1,4);
   TH1F *h_E2_1 = new TH1F("P2_1","P2 in lab system",150,1,4);
   ...
   TH1F *h_P_miss_1 = new TH1F("P_miss_1","P_{ miss} in ^{12}C reference system",100,0,1.);
   TH1F *h_P_miss_2 = new TH1F("P_miss_2","P_{ miss} in ^{12}C reference system",100,0,1.);
   TH1F *h_P_miss = new TH1F("P_miss","P_{ miss} in ^{12}C reference system",100,0,1.); 
   // h_P_miss->SetStats(0);
   ...
   TH1F *h_E_miss_with_tail_1 = new TH1F("E_miss_with_tail_1","E_{ miss} in ^{12}C reference system",83,-1,1.5);
   ...
   TH1F *h_M_miss_square_beforeQE = new TH1F("M_miss_square_beforeQE","M^{2}_{ miss } in ^{12}C reference system",80,-0.64,1.92);
   TH1F *h_M_miss_square_beforeQE_1 = new TH1F("M_miss_square_beforeQE_1","M^{2}_{ miss } in ^{12}C reference system",80,-0.64,1.92);
   ...
   TFile *file_output_QE = new TFile("./QE_Simulation_v1p2_10Mio.root","RECREATE"); // "UPDATE"
   ...
   Double_t NormFactor = 1.49423e+06; // No beta cut
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if(Flag_left==1&&Flag_right==1){
         ...
         // }
         // if(QE_cut_Mmiss2(E_miss,theta1+theta2)&&QE_Cut_Flag) Continue_Flag=1;
   ...
   TFile *My_output = new TFile("./my_output_v1p2_10Mio.root", "RECREATE");
   h_vertex_z->Write();
   h_vertex_x->Write();
   h_vertex_y->Write();
   h_vertex_xy->Write();
   ...
   TFile *My_output_generator = new TFile("./my_output_generator_v1p2_10Mio.root", "RECREATE");
   h_vertex_z_1->Write();
   h_vertex_x_1->Write();
   h_vertex_y_1->Write();
   h_vertex_xy_1->Write();
   ...
   if(Experiment_Flag==1){
      l_p1x->AddEntry(h_p1x_3,"Experiment July 17","l");
   }
   l_p1x->Draw("HIST");
   ...
   if(Experiment_Flag==1){
      l_p1y->AddEntry(h_p1y_3,"Experiment July 17","l");
   }
   l_p1y->Draw("HIST");
   ...
   if(Experiment_Flag==1){
      l_p1z->AddEntry(h_p1z_3,"Experiment July 17","l");
   }
   l_p1z->Draw("HIST");
   ...
   if(Experiment_Flag==1){
      l_E1->AddEntry(h_E1_3,"Experiment July 17","l");
   }
   l_E1->Draw("HIST");
   ...
   if(Experiment_Flag==1){
      l_p2x->AddEntry(h_p2x_3,"Experiment July 17","l");
   }
   l_p2x->Draw("HIST");
   ...
   if(Experiment_Flag==1){
      l_p2y->AddEntry(h_p2y_3,"Experiment July 17","l");
   }
   l_p2y->Draw("HIST");
   ...
   if(Experiment_Flag==1){
      l_p2z->AddEntry(h_p2z_3,"Experiment July 17","l");
   }
   l_p2z->Draw("HIST");
   ...
   if(Experiment_Flag==1){
      l_E2->AddEntry(h_E2_3,"Experiment July 17","l");
   }
   l_E2->Draw("HIST");
   ...
   // l_p1xp2x->AddEntry(h_p1xp2x_3,"Experiment July 17","l");
   // l_p1xp2x->Draw("HIST");
   ...
   // l_p1yp2y->AddEntry(h_p1yp2y_3,"Experiment July 17","l");
   // l_p1yp2y->Draw("HIST");
   ...
   if(Experiment_Flag==1){
      l_p1zp2z->AddEntry(h_p1zp2z_3,"Experiment July 17","l");
   }
   l_p1zp2z->Draw("HIST");
   ...
   // l_P_miss->AddEntry(h_P_miss_3,"Experiment July 17","l");
   // l_P_miss->Draw("HIST");
   ...
   if(Experiment_Flag==1){
      l_E_miss->AddEntry(h_E_miss_3,"Experiment July 17","l");
   }
   l_E_miss->Draw("HIST");
   ...
   if(Experiment_Flag==1){
      l_M_miss_square->AddEntry(h_M_miss_square_3,"Experiment July 17","l");
   }
   ...
   // l_opening_theta->AddEntry(h_opening_theta_3,"Experiment July 17","l");
   ...
   // l_opening_phi->AddEntry(h_opening_phi_3,"Experiment July 17","l");
   ...
   l_phi1->AddEntry(h_phi1_3,"Experiment July 17","l");
   l_phi1->Draw("HIST");
   ...
   l_phi2->AddEntry(h_phi2_3,"Experiment July 17","l");
   l_phi2->Draw("HIST");
   ...
   if(Experiment_Flag==1){
      l_Angle_Pmiss_PFrag_cos->AddEntry(h_Angle_Pmiss_PFrag_cos_3,"Experiment July 17","l");
   }
   ...
   if(Experiment_Flag==1){
      l_M_miss_square_frag->AddEntry(h_M_miss_square_exp,"Experiment July 17","l");
   }
   ...
   if(Experiment_Flag==1){
      l_P_miss_frag->AddEntry(h_P_miss_exp,"Experiment July 17","l");
   }
   ...
   if(Experiment_Flag==1){
      l_P_miss_x_frag->AddEntry(h_P_miss_x_exp,"Experiment July 17","l");
   }
   ...
   if(Experiment_Flag==1){
      l_P_miss_y_frag->AddEntry(h_P_miss_y_exp,"Experiment July 17","l");
   }
   ...
   if(Experiment_Flag==1){
      l_P_miss_z_frag->AddEntry(h_P_miss_z_exp,"Experiment July 17","l");
   }
