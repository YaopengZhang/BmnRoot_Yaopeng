...
UniSimulationFile::UniSimulationFile(UniConnection* db_connect, int file_id, TString file_path, TString generator_name, TString beam_particle, TString* target_particle, double* energy, TString centrality, int* event_count, TString* file_desc, int64_t* file_size, TString* file_md5)
{
...
UniSimulationFile* UniSimulationFile::CreateSimulationFile(TString file_path, TString generator_name, TString beam_particle, TString* target_particle, double* energy, TString centrality, int* event_count, TString* file_desc, int64_t* file_size, TString* file_md5)
{
    ...
    return new UniSimulationFile(connDb, tmp_file_id, tmp_file_path, tmp_generator_name, tmp_beam_particle, tmp_target_particle, tmp_energy, tmp_centrality, tmp_event_count, tmp_file_desc, tmp_file_size, tmp_file_md5);
}
...
int UniSimulationFile::SetFileMd5(TString* file_md5)
{
    if (!connectionDB)
    {
        cout<<"CRITICAL ERROR: Connection object is null"<<endl;
...
TObjArray* UniSimulationFile::GetSimulationFiles()
{
    ...
    while (stmt->NextResultRow())
    {
        ...
        arrayResult->Add((TObject*) new UniSimulationFile
            (connDb, tmp_file_id, tmp_file_path, tmp_generator_name, tmp_beam_particle, tmp_target_particle, tmp_energy, tmp_centrality, tmp_event_count, tmp_file_desc, tmp_file_size, tmp_file_md5));
    }
...
TObjArray* UniSimulationFile::Search(TObjArray& search_conditions)
{
    ...
    while (stmt->NextResultRow())
    {
        ...
        arrayResult->Add((TObject*) new UniSimulationFile(connDb, tmp_file_id, tmp_file_path, tmp_generator_name, tmp_beam_particle, tmp_target_particle, tmp_energy, tmp_centrality, tmp_event_count, tmp_file_desc, tmp_file_size, tmp_file_md5));
    }
