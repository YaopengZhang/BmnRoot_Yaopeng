...
public:
    BmnTof2Raw2DigitNew(TString mappingFile, TString RunFile = "empty", Int_t SlewingRun = 0, UInt_t SlewingChamber = 0, TString geomFile="TOF700_geometry_run8_SRC.txt");
    BmnTof2Raw2DigitNew();
